	...
	<table width="600" border="0" cellspacing="0" cellpadding="0" style="border: 1px solid #a1d0e4;">
				...
				<table width="96%" border="0" cellspacing="0" cellpadding="0" style="margin: 0 2%">
					<tr>
						<td style="font-size: 15px; padding: 30px 0 30px 0; color: #525252; line-height: 21px; text-align: left;">
							...
							<br />
							<br />
							This is to remind you on the upcoming meeting for the following event<br />
		...
		<tr>
			<td>
				<table width="96%" border="0" cellspacing="0" cellpadding="0" style="margin: 0 2%">
					<tr>
						<td style="font-size: 15px; padding: 5px 0 5px 0; color: #525252; line-height: 21px; text-align: left;">
								<b>${meetingType}</b>
						</td>
						<td style="font-size: 15px; padding: 5px 0 5px 0; color: #525252; line-height: 21px; text-align: right;">
					...
					<tr>
						<td style="font-size: 15px; padding: 5px 0 5px 0; color: #525252; line-height: 21px; text-align: left;">
						  <b>Contact Person:</b> <br />
							<#list contactPerson as contact>
  						    <p>${contact.contactName}<br />
  						      ${contact.contactEmail}<br />
  						      ${contact.contactNumber}</p>
							</#list>
							</td>
							<td style="font-size: 15px; color: #525252; line-height: 21px; text-align: right;">
								<b>Venue:</b> <br />
									${venue}
						</td>
					</tr>
