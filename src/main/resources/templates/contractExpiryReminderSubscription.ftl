				...
				<table width="96%" border="0" cellspacing="0" cellpadding="0" style="margin: 0 2%">
					<tr>
						<td style="font-size: 14px; padding: 30px 0 30px 0; color: #525252; line-height: 21px; text-align: left;">
							...
							<br />
							<br />
							The following contract is expiring on <i>"${endDate}"</i>.
							<br />
							<b>Contract Reference : </b> ${reference} 
							<br />
							<b> Supplier : </b> ${supplierCompany}
							<br />
							<b> Group Code : </b> ${groupCode}
							<br />
							<b> Bussiness Unit : </b> ${bu}
