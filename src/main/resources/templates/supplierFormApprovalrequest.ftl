				...
				<table width="96%" border="0" cellspacing="0" cellpadding="0" style="margin: 0 2%">
					<tr>
						<td style="font-size: 14px; padding: 30px 0 30px 0; color: #525252; line-height: 21px; text-align: left;">
							...
							<br />
							<br />
							Your attention is required for the Approval of following Supplier Form.
							<br/>
							<b>Form Name : </b> ${supplierForm.name}
							<br />
							<b>Supplier Company Name : </b> ${supplierForm.supplier.companyName}
							<br />
							<b>Form Submission Date : </b> ${submitedDate}
						</td>
					</tr>
				</table>
			</td>
