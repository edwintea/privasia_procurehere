    ...
    <td style="background:#0095d5;"><table width="96%" border="0" cellspacing="0" cellpadding="0" style="margin:0 2%">
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td style="font-size:13px; color:#fff; padding:10px 0"> <b>PROCUREHERE</b> <!-- <a href="#" style="color:#fff; text-decoration:none;">View in Browser</a> --> </td>
...
<table width="96%" border="0" cellspacing="0" cellpadding="0" style="margin: 0 2%">
					<tr>
						<td style="font-size: 15px; padding: 30px 0 30px 0; color: #525252; line-height: 21px; text-align: left;">
							...
							<br />
							<br />
							Your procurehere account has been created.<br />
    ...
    <td><table width="96%" border="0" cellspacing="0" cellpadding="0" style="margin:0 2%">
	  ...
	  <td style="width:20%">&nbsp;</td>
        <td style="padding:0 0 30px 0">
        	<a class="email_bttn" href="${appLink}">CLICK HERE TO GET STARTED</a>
        </td>
		<td style="width:20%">&nbsp;</td>
      </tr>
  ...
  <table width="96%" border="0" cellspacing="0" cellpadding="0" style="margin:0 2%">
	  ...
	  If the button appears to be broken, please copy and paste this link into a web browser window:  <a href="${appLink}" style="word-break:break-all; font-size:8px;"> ${appLink}
	  </a>
	  </td>
      </tr>
  ...
  <tr>
    <td style="background:#0095d5"><table width="96%" border="0" cellspacing="0" cellpadding="0" style="margin:0 2%">
      <tr>
        <td class="footer">&copy; 2017 Privasia Sdn Bhd.</td>
      </tr>
    </table></td>
  </tr>
</table>
