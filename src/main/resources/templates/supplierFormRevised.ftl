				...
				<table width="96%" border="0" cellspacing="0" cellpadding="0" style="margin: 0 2%">
					<tr>
						<td style="font-size: 14px; padding: 30px 0 30px 0; color: #525252; line-height: 21px; text-align: left;">
							...
							<br />
							<br />
							Buyer ${buyerName} has requested you to revise your form submission.
							<br />
							<b>Form Name : </b> <i>${formName}</i>
							<br/>
							<b>Form Assigned Date : </b> ${requestedDate}
							<br/>
							<b>Form Submitted Date : </b> ${submittedDate}
							<br/>
                            <b>Comments : </b> ${buyerRemark}
							<br/>	
							<b>Action By : </b> ${actionBy}
						</td>
					</tr>
				</table>
			</td>
