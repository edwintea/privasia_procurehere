				...
				<table width="96%" border="0" cellspacing="0" cellpadding="0" style="margin: 0 2%">
					<tr>
						<td style="font-size: 14px; padding: 30px 0 30px 0; color: #525252; line-height: 21px; text-align: left;">
							...
							<br />
							<h4>Approval Reminder ${remCount}</h4>
							<br />
							<br />
							Your attention is required for Approval following revised PO
							<br />
							<b>PO Number : </b> <i>${po.poNumber}</i>
							<br />
							<b>PO Name : </b> <i>${po.name}</i>
							<br />
							<b>PO Date : </b> <i>${poDate}</i>
							<br/>
							<b>Business Unit : </b> ${businessUnit} </b>
							<br/>		
							<b>Justification : </b> ${po.reviseJustification}
							<br/>
						</td>
					</tr>
				</table>
