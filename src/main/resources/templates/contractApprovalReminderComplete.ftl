				...
				<table width="96%" border="0" cellspacing="0" cellpadding="0" style="margin: 0 2%">
					<tr>
						<td style="font-size: 14px; padding: 30px 0 30px 0; color: #525252; line-height: 21px; text-align: left;">
							...
							<br />
							<br />
							<b>Approval Level Inaction</b>
							<br />
							<br />
							Kindly take note of the Approval Level Inaction for the following Contract
							<br />
							<b>Contract ID : </b> <i>${contractId}</i>
							<br/>
							<b>Contract Name : </b> ${contractName}
							<br/>
							<b>Approver Level : </b> <i>${approverLevel}</i>
							<br/>
							<b>Approver : </b> <i>${approverName}</i>
							<br/>
							<b>Approval Reminder Configuration : </b> ${msg}	
						</td>
					</tr>
				</table>
			</td>
