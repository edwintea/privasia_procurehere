				...
				<table width="96%" border="0" cellspacing="0" cellpadding="0" style="margin: 0 2%">
					<tr>
						<td style="font-size: 14px; padding: 30px 0 30px 0; color: #525252; line-height: 21px; text-align: left;">
							...
							<br />
							Approval Level Inaction
							<br />
							<br />
							Kindly take note of the Approval level Inaction for the following revised PO
							<br />
							<b>PO Number : </b> <i>${po.poNumber}</i>
							<br />
							<b>PO Name : </b> <i>${po.name}</i>
							<br />
							<b>Approval Level : </b> <i>${approvalLevel}</i>
							<br/>
							<b>Approvers : </b> ${approvers} </b>
							</br>
                            <b>Approval Reminder Configuration : </b> Every ${po.reminderAfterHour} hours up to ${po.reminderCount} Reminders.
							<br/>		
						</td>
					</tr>
				</table>
