				...
				<table width="96%" border="0" cellspacing="0" cellpadding="0" style="margin: 0 2%">
					<tr>
						<td style="font-size: 14px; padding: 30px 0 30px 0; color: #525252; line-height: 21px; text-align: left;">
							...
							to be a team member with <b> ${memberType}</b> access in the creation of this PR :<b> ${eventName}</b>
							<br/>
							<b>PR ID :</b> ${eventId} 
							<br/>
							...
							Please contact the event creator for more details.
							<br/>
							<b> Event Creator Name:</b>${createdBy} 
							<br/>
							<b> Event Creator Email:</b> ${createrEmail}
