				...
				<table width="96%" border="0" cellspacing="0" cellpadding="0" style="margin: 0 2%">
					<tr>
						<td style="font-size: 14px; padding: 30px 0 30px 0; color: #525252; line-height: 21px; text-align: left;">
							...
							<br />
							<br />
							Auto subscription has been renewed for "${loginEmail}".<br />
							<b>Selected Plan 	 : </b>${plan}<br/>
							<b>Plan Description : </b>${planDesc}<br/>
							<b> Subscription Validity :</b> ${startDate} - ${endDate}
							<br />
							<b> Amount :</b> ${currencyCode}&nbsp; ${amount}
						</td>
					</tr>
				</table>
			</td>
