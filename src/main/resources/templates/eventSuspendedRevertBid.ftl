				...
				<table width="96%" border="0" cellspacing="0" cellpadding="0" style="margin: 0 2%">
					<tr>
						<td style="font-size: 14px; padding: 30px 0 30px 0; color: #525252; line-height: 21px; text-align: left;">
							...
							<br />
							<br />
							You are assigned as Revert Last Bid Owner for the following Event which is now suspended
							<br />
							...
							<br />
							<b>Reference Number : </b> ${event.referanceNumber}
							<br />
							<#if suspendRemarks?has_content>
                            <b>Remarks : </b> ${suspendRemarks}
                            </#if>
							<br/>
						</td>
					</tr>
