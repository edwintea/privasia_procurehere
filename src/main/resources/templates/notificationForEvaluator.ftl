				...
				<table width="96%" border="0" cellspacing="0" cellpadding="0" style="margin: 0 2%">
					<tr>
						<td style="font-size: 14px; padding: 30px 0 30px 0; color: #525252; line-height: 21px; text-align: left;">
							...
							<br />
							<br />
							You have been assigned as Evaluator for Supplier Performance Evaluation Form below
							<br />
							<b>Form ID : </b> <i>${formId}</i>
							<br/>
							<b>Reference Number : </b> ${referenceNumber}
							<br/>
							<b>Reference Name : </b> ${referenceName}
							<br/>
							<b>Evaluation Start date : </b> ${startDate}
							<br/>
							<b>Evaluation End date : </b> ${endDate}
							<br/>
