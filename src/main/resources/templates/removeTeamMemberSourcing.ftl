				...
				<table width="96%" border="0" cellspacing="0" cellpadding="0" style="margin: 0 2%">
					<tr>
						<td style="font-size: 14px; padding: 30px 0 30px 0; color: #525252; line-height: 21px; text-align: left;">
							...
							<br />
							<br />
							You have been removed by <b> ${createdBy}</b> 
							
							to be a team member with <b> ${memberType}</b> access in the creation of this Sourcing Request :<b> ${eventName}</b>
							<br/>
							<b>Form ID :</b> ${eventId} 
							<br/>
							...
							Please contact the Sourcing Request creator for more details.
							<br/>
							<b> Sourcing Request Creator Name:</b>${createdBy} 
							<br/>
							<b> Sourcing Request Creator Email:</b> ${createrEmail}
