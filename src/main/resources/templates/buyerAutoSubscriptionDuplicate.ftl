				...
				<table width="96%" border="0" cellspacing="0" cellpadding="0" style="margin: 0 2%">
					<tr>
						<td style="font-size: 14px; padding: 30px 0 30px 0; color: #525252; line-height: 21px; text-align: left;">
							<h3>Hi Application Admin</h3>
							Welcome to procurehere
							<br />
							<br />
							This is need to be attention that there may be a possibility of duplicate response from Pay Pal during auto subscription for "${loginEmail}".<br />
							These are the following response from pay pal :- <br/>
							<b>Payer Email 	 : </b>${payerEmail}<br/>
							<b>Recurring Payment Id	 : </b>${recurringPaymentId}<br/>
				...
				<table width="96%" border="0" cellspacing="0" cellpadding="0" style="margin: 0 2%">
					<tr>
						...
						<td style="padding: 0 0 30px 0">
							<a class="email_bttn" href="${loginUrl}">CLICK HERE TO GET STARTED</a>
						</td>
						<td style="width: 20%">&nbsp;</td>
					</tr>
				</table>
