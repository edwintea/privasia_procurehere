				...
				<table width="96%" border="0" cellspacing="0" cellpadding="0" style="margin: 0 2%">
					<tr>
						<td style="font-size: 14px; padding: 30px 0 30px 0; color: #525252; line-height: 21px; text-align: left;">
							...
							<br />
                            <h4>Approval Level Inaction </h4>
							<br />
								 Kindly take note of the Approval Level Inaction for the following Request.
							<br />
							<b>Request Name : </b> <i>${eventName}</i>
							<br/>
							<b>Reference Number : </b> <i>${refNumber}</i>
							<br/>
							<b>Approval Level : </b> ${approvalLevel}
							<br/>
							<b>Approvers : </b> ${approvers}
							<br/>
							<b>Approval Reminder Configuration : </b> Every ${reminderAfterHour} hours up to ${reminderCount} Reminders.
