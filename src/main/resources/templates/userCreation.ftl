...
<table width="600" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #a1d0e4;">
  ...
  <tr>
    <td><table width="96%" border="0" cellspacing="0" cellpadding="0" style="margin:0 2%">
      <tr>
		...
		Your account has been created with the login id <b>${loginId}</b></br> 
    ...
    <td><table width="96%" border="0" cellspacing="0" cellpadding="0" style="margin:0 2%">
	  ...
	  <td style="width:20%">&nbsp;</td>
        <td style="padding:0 0 30px 0">
        	<a class="email_bttn" href="${appUrl}">CLICK HERE TO LOGIN</a>
        </td>
		<td style="width:20%">&nbsp;</td>
      </tr>
  ...
  <table width="96%" border="0" cellspacing="0" cellpadding="0" style="margin:0 2%">
	  ...
	  If the button appears to be broken, please copy and paste this link into a web browser window:  <a href="${appUrl}" style="word-break:break-all; font-size:8px;"> ${appUrl}
	  </a>
	  </td>
      </tr>
