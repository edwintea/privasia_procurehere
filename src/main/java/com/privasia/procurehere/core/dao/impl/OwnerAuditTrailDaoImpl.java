 ...
 */
@Repository
public class OwnerAuditTrailDaoImpl extends GenericDaoImpl<OwnerAuditTrail, String> implements OwnerAuditTrailDao {
	...
	public List<OwnerAuditTrail> findOwnerAuditTrailForTenant(String tenantId, TableDataInput input, Date startDate, Date endDate, String moduleType) {
		final Query query = constructOwnerAuditTrailForTenantQuery(tenantId, input, false, startDate, endDate, moduleType);
	...
	public long findTotalFilteredOwnerAuditTrailForTenant(String loggedInUserTenantId, TableDataInput input, Date startDate, Date endDate, String moduleType) {
		final Query query = constructOwnerAuditTrailForTenantQuery(loggedInUserTenantId, input, true, startDate, endDate, moduleType);
		return ((Number) query.getSingleResult()).longValue();
	}

	@Override
	public long findTotalOwnerAuditTrailForTenant(String loggedInUserTenantId) {
		StringBuilder hql = new StringBuilder("select count (at) from OwnerAuditTrail at where at.tenantId = :tenantId ");
	 ...
	 * @return
	 */
	private Query constructOwnerAuditTrailForTenantQuery(String tenantId, TableDataInput input, boolean isCount, Date startDate, Date endDate, String moduleType) {
