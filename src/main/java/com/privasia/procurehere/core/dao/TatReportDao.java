 ...
 * @author jayshree
 */
public interface TatReportDao extends GenericDao<TatReport, String> {
	 ...
	 * @return
	 */
	boolean isRfsExistsByFormIdAndTenantId(String formId, String tenantId);
	 ...
	 * @return
	 */
	TatReport getEventsDataForTatReportListByEventIdAndFormIdAndTenantId(String formId, String eventId, String tenantId);
	 ...
	 * @return
	 */
	List<TatReport> findAllTatReportForTenantIdForCsv(int pageSize, int pageNo, TatReportPojo tatReport);
	...
	/**
	 * @param id
	 * @param eventOpenDuration
	 * @param invitedSupplierCount
	 * @param acceptedSupplierCount
	 * @param submitedSupplierCount
	 */
	void updateTatReportOnEventEnd(String id, BigDecimal eventOpenDuration, Integer invitedSupplierCount, Integer acceptedSupplierCount, Integer submitedSupplierCount);
	 ...
	 * @param tenantId TODO
	 */
	void updateTatReportSapPrId(String id, String sapPrId, String tenantId);
	 ...
	 * @param eventFirstApprovedDate
	 */
	void updateTatReportEventFirstApprovedDate(String requestGeneratedId, String eventId, String tenantId, Date eventFirstApprovedDate);
	 ...
	 * @return
	 */
	TatReport getEventDetailsForTatReportByEventIdAndTenantId(String eventGeneratedId, String tenantId);
	 ...
	 * @return
	 */
	TatReportPojo getEventStartAndEndDatasForTatReportByEventIdAndTenantId(String eventGeneratedId, String tenantId);
	...
	TatReport getTatReportyEventIdAndTenantIdAndEventTypeAndPrNo(String eventId, String tenantId, RfxTypes eventType);
