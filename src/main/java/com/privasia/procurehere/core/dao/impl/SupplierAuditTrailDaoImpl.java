 ...
 */
@Repository
public class SupplierAuditTrailDaoImpl extends GenericDaoImpl<SupplierAuditTrail, String> implements SupplierAuditTrailDao {
	...
	public long findTotalAuditTrailForTenant(String loggedInUserTenantId) {
		StringBuilder hql = new StringBuilder("select count (at) from SupplierAuditTrail at where at.tenantId = :tenantId ");
	...
	private Query constructAuditTrailForTenantQuery(String tenantId, TableDataInput input, boolean isCount, Date startDate, Date endDate, String moduleType) {
		...
		hql += " from SupplierAuditTrail at ";
