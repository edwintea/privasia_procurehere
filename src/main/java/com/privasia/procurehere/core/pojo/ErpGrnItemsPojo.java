...
public class ErpGrnItemsPojo implements Serializable {
	...
	public String toLogString() {
		return "ErpGrnItemsPojo [itemNo=" + itemNo + ", itemCode=" + itemCode + ", itemName=" + itemName + ", uom=" + uom + ", businessUnit=" + businessUnit + ", quantity=" + quantity + ", unitPrice=" + unitPrice + ", totalAmount=" + totalAmount + ", itemTax=" + itemTax + ", taxAmount=" + taxAmount + ", totalAmountWithTax=" + totalAmountWithTax + "]";
	}
