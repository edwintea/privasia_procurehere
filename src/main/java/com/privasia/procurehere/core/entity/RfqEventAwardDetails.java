...
@Entity
@Table(name = "PROC_RFQ_EVENT_AWARD_DETAILS")
public class RfqEventAwardDetails extends AwardDetails implements Serializable {

	private static final long serialVersionUID = 2380243016865784373L;

	@ManyToOne(optional = true, cascade = { CascadeType.PERSIST, CascadeType.MERGE })
	@JoinColumn(name = "EVENT_AWARD", nullable = true, foreignKey = @ForeignKey(name = "FK_RFQ_EVNT_AWD_DT"))
	private RfqEventAward eventAward;

	@ManyToOne(optional = false, cascade = { CascadeType.REFRESH })
	@JoinColumn(name = "BQ_ITEM_ID", nullable = false, foreignKey = @ForeignKey(name = "FK_RFQ_EVNT_AWD_BQ_ITEM"))
	 ...
	 */
	public RfqEventAward getEventAward() {
		return eventAward;
	}
	 ...
	 */
	public void setEventAward(RfqEventAward eventAward) {
	...
	/*
	 * @Override public String toString() { return "RfqEventAwardDetails [eventAward=" + eventAward + ", bqItem=" +
	 * bqItem + "]"; }
	 */
