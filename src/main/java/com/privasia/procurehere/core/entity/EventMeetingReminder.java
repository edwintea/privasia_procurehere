...
@MappedSuperclass
public class EventMeetingReminder implements Serializable {

	private static final long serialVersionUID = -1330266863469771332L;
...
private Boolean reminderSent = Boolean.FALSE;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EventMeetingReminder other = (EventMeetingReminder) obj;
	...
	public String toLogString() {
		return "EventMeetingReminder [id=" + id + ", reminderDate=" + reminderDate + ", interval=" + interval + ", intervalType=" + intervalType + ", reminderSent=" + reminderSent + "]";
	}
