 ...
 */
@Entity
@Table(name = "PROC_RFI_EVENT_CONTACTS")
public class RfiEventContact extends EventContact implements Serializable {

	private static final long serialVersionUID = -238844061639663345L;

	@JsonIgnore
	@ManyToOne(fetch = FetchType.LAZY, optional = true)
	@JoinColumn(name = "EVENT_ID", foreignKey = @ForeignKey(name = "FK_RFI_EVENT_CONTACT") )
	private RfiEvent rfxEvent;

	@Transient
	private String eventId;

	public RfiEventContact copyFrom(RfiEvent rfiEvent) {
	...
	public String toLogString() {
		return "EventContact [ " + super.toLogString() + "]";
	}
