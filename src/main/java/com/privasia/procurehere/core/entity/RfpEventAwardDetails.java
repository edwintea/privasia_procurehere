...
@Entity
@Table(name = "PROC_RFP_EVENT_AWARD_DETAILS")
public class RfpEventAwardDetails extends AwardDetails implements Serializable {

	private static final long serialVersionUID = 2380243016865784373L;

	@ManyToOne(optional = true, cascade = { CascadeType.PERSIST, CascadeType.MERGE })
	@JoinColumn(name = "EVENT_AWARD", nullable = true, foreignKey = @ForeignKey(name = "FK_RFP_EVNT_AWD_DT"))
	private RfpEventAward eventAward;

	@ManyToOne(optional = false, cascade = { CascadeType.REFRESH })
	@JoinColumn(name = "BQ_ITEM_ID", nullable = false, foreignKey = @ForeignKey(name = "FK_RFP_EVNT_AWD_BQ_ITEM"))
	 ...
	 */
	public RfpEventAward getEventAward() {
		return eventAward;
	}
	 ...
	 */
	public void setEventAward(RfpEventAward eventAward) {
	...
	/*
	 * @Override public String toString() { return "RfpEventAwardDetails [eventAward=" + eventAward + ", bqItem=" +
	 * bqItem + "]"; }
	 */
