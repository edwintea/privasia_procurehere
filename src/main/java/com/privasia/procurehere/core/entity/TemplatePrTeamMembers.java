 ...
 */
@Entity
@Table(name = "PROC_TEMPLATE_PR_TEAM")
public class TemplatePrTeamMembers extends EventTeamMember implements Serializable {

	private static final long serialVersionUID = -8867221756717560750L;

	@JsonIgnore
	@ManyToOne(fetch = FetchType.LAZY, optional = true)
	@JoinColumn(name = "PR_TEMPLATE_ID", foreignKey = @ForeignKey(name = "FK_TMPL_PR_TEAM_MEMBERS_ID"))
