...
@Entity
@Table(name = "PROC_RFP_MEETING_DOC")
public class RfpEventMeetingDocument extends EventMeetingDocument implements Serializable {

	private static final long serialVersionUID = 4816197913407302530L;

	@JsonIgnore
	@ManyToOne(fetch = FetchType.LAZY, optional = false, cascade = { CascadeType.PERSIST, CascadeType.REFRESH })
	@JoinColumn(name = "EVENT_MEETING_ID", foreignKey = @ForeignKey(name = "FK_RFP_EVENT_MEET_DOC"))
	private RfpEventMeeting rfxEventMeeting;

	public RfpEventMeetingDocument() {
	}

	public RfpEventMeetingDocument(EventDocumentPojo documentPojo) {
	...
	public RfpEventMeetingDocument(String id, String fileName, String credContentType, String tenantId, Integer fileSizeInKb) {
		super.setId(id);
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RfpEventMeetingDocument other = (RfpEventMeetingDocument) obj;
