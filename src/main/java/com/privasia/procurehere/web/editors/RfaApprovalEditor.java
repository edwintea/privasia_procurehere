...
@Component
public class RfaApprovalEditor extends PropertyEditorSupport {
	...
	public void setAsText(String value) {
		if (StringUtils.checkString(value).length() > 0) {
			...
			this.setValue(new RfaApprovalUser(user));
		}
	}

	@Override
	public String getAsText() {
		return getValue() == null ? "" : ((RfaApprovalUser) getValue()).getUser().getId();
	}
}
