 ...
 * @author Giridhar
 */
public class PoSummaryPojo implements Serializable {
	...
	// PR Items
	private List<PoItemsSummaryPojo> prItems;
	 ...
	 * @return the prItems
	 */
	public List<PoItemsSummaryPojo> getPrItems() {
		return prItems;
	}
	 ...
	 */
	public void setPrItems(List<PoItemsSummaryPojo> prItems) {
