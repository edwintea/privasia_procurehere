...
public interface RfaSupplierSorItemService {
    ...
    List<RfaSupplierSorItem> saveSupplierEventSor(String bqId);
    ...
    List<RfaSupplierSorItem> getAllSupplierSorItemBySorIdAndSupplierId(String bqId, String supplierId);


    List<RfaSupplierSorItem> getAllSupplierSorItemForReportBySorIdAndSupplierId(String sorId, String id);


    List<RfaSupplierSorItem> getAllSupplierSorItemForReportBySorIdAndSupplierIdParentIdNotNull(String sorId, String id);
}
