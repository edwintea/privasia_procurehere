...
<div class="container margin-bottom-5">
  <div class="purchase-outline border-btm-centered">
    ...
    <p>You will soon receive an email confirming your subscription details.</p>
    </div>
</div>
<div class="container login-options nopad-margin">
  <div class="row purchase-support">
    ...
    <div class="col-sm-3 col-md-3 col-lg-3 col-xs-12 redirect-here-section">
      ...
      <p>If you have any further questions<br>or need support with your setup,<br> we offer 24/7 helpdesk support<br>through our helpline on<br> <a href="#" class="phone-number"> 1-800-88-77-48</a> and live chat on<br>the PROCUREHRE homepage.</p>
    ...
    <div class="col-sm-3 col-md-3 col-lg-3 col-xs-12 redirect-here-section">
      ...
      <p>Finally, if you want to explore a<br> world of PROCUREHRE insight,<br>why not take look at the<br>PROCUREHRE blog for all the<br>latest procurement news?</p>
