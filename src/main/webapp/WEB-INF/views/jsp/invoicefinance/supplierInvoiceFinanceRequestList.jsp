...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
	<div id="page-content" view-name="supplierInvoiceFinanceRequestList">
												...
												<table id="tableList" class="data  display table table-bordered noarrow" cellspacing="0" width="100%">
													<thead>
														...
														<%-- 	<th search-type="text" class="align-left width_200 width_200_fix"><spring:message code="supplier.invoiceListing.referenceNumber" /></th> --%>
															...
															<th search-type="text" class="align-left width_200 width_200_fix"><spring:message code="application.buyer"/></th>
	...
	<script type="text/javascript">
		$('document').ready(function() {
			...
			var table = $('#tableList').DataTable({
				...
				"searching" : true,
				"ajax" : {
					"url" : getContextPath() + "/supplier/invoiceFinanceRequest/requestListData",
					"data" : function(d) {
				...
				"columns" : [ 
					...
					"mRender" : function(data, type, row) {
						var action = '<a href="../invoice/' + row.invoiceId + '" data-placement="top" title=<spring:message code="tooltip.edit" /> ><img src="${pageContext.request.contextPath}/resources/images/edit1.png"></a>&nbsp;&nbsp;';
						return action;
					}
				},{
					"data" : "invoiceNumber",
