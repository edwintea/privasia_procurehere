...
<div class="panel sum-accord marg-top-5">
	...
	<div id="collapseAudit" class="panel-collapse collapse in">
		<div class="panel-body">
			<div class="table-responsive width100 borderAllData pad_all_15 float-left width-100">
								...
								<td class="align-left width_100_fix">
									<c:if test="${not empty audit.snapshot}">
										...
										<form:form method="GET">
											<c:url var="download" value="/supplier/${eventType}/downloadPoAuditFile/${audit.id}/${audit.action}/${actionDate}" />
