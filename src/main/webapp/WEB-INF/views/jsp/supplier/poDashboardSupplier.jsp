...
<div class="main-div marg-top-20">
    <div class="row">
        <div class="col_12">
            <div class="box-main OorderedContainer" >
                ...
                <div class="box-bottom" data-target="ORDERED">
                    <div class="orange-con orderedContainer">${orderedPoCount}</div>
                    <span><spring:message code="buyer.dashboard.po.ordered"/></span>
                </div>
            </div>

            <div class="box-main acceptanceContainer" >
                <div class="box-top limegreen">
                    <span><spring:message code="buyer.dashboard.po.acceptance" /> </span> <img src="${pageContext.request.contextPath}/resources/images/buyerDashboardImages/ongoing-event.png" alt="pending">
                </div>

                <div class="box-bottom width50" data-target="ACCEPTED">
                    <div class="limegreen-con border-right-shaded acceptanceContainer">${acceptedPoCount}</div>
                    <span><spring:message code="supplier.dashboard.accepted" /></span>
                </div>

                <div class="box-bottom width50" data-target="DECLINED">
                    <div class="red border-right-shaded acceptanceContainer">${declinedPoCount}</div>
                    <span><spring:message code="supplier.dashboard.declined" /></span>
                </div>
    ...
    <div class="row">
        <div class="col_12">
            <div class="box-main suspendedContainer" >
                <div class="box-top redPo">
                    <span><spring:message code="buyer.dashboard.po.suspended"/></span>
                    <img src="${pageContext.request.contextPath}/resources/images/buyerDashboardImages/ongoing-event.png" alt="ongoing-event">
                </div>
                <center>
                    <div class="box-bottom" data-target="SUSPENDED,PENDING,READY">
                        <div class="red suspendedContainer">${suspendedPoCount}</div>
                        <span><spring:message code="buyer.dashboard.po.suspended"/></span>
                    </div>
                </center>
            </div>

            <div class="box-main closedContainer" data-target="CLOSED">
                <div class="box-top light-blue">
                    <span><spring:message code="buyer.dashboard.po.closed" /> </span> <img src="${pageContext.request.contextPath}/resources/images/buyerDashboardImages/pending-event.png" alt="pending">
                </div>
                ...
                <div class="box-bottom width50" data-target="CANCELLED">
                    <div class="light-blue-con pendingContainer">${cancelledPoCount}</div>
                    <span>Cancelled</span>
                </div>
            </div>
        </div>
	...
	<c:if test="${isBuyerErpEnable}">
		<div class="box-main prcheseOrdersContainer" >
			...
			<div class="box-bottom width50" data-target="CLOSED">
				<div class="light-blue-con border-right-shaded closedContainer"></div>
				<span><spring:message code="buyer.dashboard.po.closed"/></span>
			</div>
			<div class="box-bottom width50" data-target="CANCELLED">
				<div class="light-blue-con finishedContainer"></div>
