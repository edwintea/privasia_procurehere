...
<spring:message var="supplierPlanListDesk" code="application.owner.supplier.subscription.plan.list" />
<script>
zE(function() {
  zE.setHelpCenterSuggestions({ labels: [${supplierPlanListDesk}] });
});
</script>
								...
								<div class="col-xs-12">
									<div class="form-group col-md-12 bordered-row">
										<div class="ph_tabel_wrapper scrolableTable_list">
											...
											<spring:url value="/admin/supplierplan/supplierplan" var="createUrl" htmlEscape="true" />
...
<script type="text/javascript" src="<c:url value="/resources/js/view/supplierplan.js"/>"></script>
<script type="text/javascript">
	$('document').ready(function() {
		...
		var table = $('#tableList').DataTable({
			...
			"searching" : true,
			"ajax" : {
				"url" : getContextPath() + "/admin/supplierplan/planData",
				"data" : function(d) {
					//var table = $('#tableList').DataTable()
			...
			"columns" : [ {
				...
				"render" : function(data, type, row) {
					var ret = '<a href="editPlan/' + row.id + '" data-placement="top" title=<spring:message code="tooltip.edit" />><img src="${pageContext.request.contextPath}/resources/images/edit1.png"></a>';
	...
	<div class="modal-dialog for-delete-all reminder">
		...
		<div class="modal-content">
			...
			<div class="modal-footer pad_all_15 float-left width-100 border-top-width-1">
				<a id="idConfirmDelete" class="btn btn-info ph_btn_small hvr-pop hvr-rectangle-out" href="${pageContext.request.contextPath}/admin/supplierplan/deletePlan/" title=<spring:message code="tooltip.delete" />>
