...
<spring:message var="stateListDesk" code="application.owner.state.list" />
<script>
zE(function() {
  zE.setHelpCenterSuggestions({ labels: [${stateListDesk}] });
});
</script>
...
<div id="page-content">
	<div class="container col-md-12">
		...
		<ol class="breadcrumb">
			...
			<li class="active"><spring:message code="state.list" /></li>
		</ol>
		<div class="Section-title title_border gray-bg">
			<h2 class="trans-cap manage_icon">
				<spring:message code="state.list.list" />
			</h2>
		</div>
								...
								<div class="ph_tabel_wrapper scrolableTable_UserList">
									<table id="tableList" class=" display table table-bordered noarrow" cellspacing="0" width="100%">
										<thead>
											<tr class="tableHeaderWithSearch">
												...
												<th search-type="text"><spring:message code="state.code" /></th>
												<th search-type="text"><spring:message code="state.name" /></th>
									...
									<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
										<button type="submit" class="btn btn-plus btn-info top-marginAdminList">
											<spring:message code="state.create" />
										</button>
									</form>
								</div>
...
// 			$('div[id=idGlobalError]').hide();
		...
		"searching" : true,
		"ajax" : {
			"url" : getContextPath() + "/admin/stateListData",
			"data" : function(d) {
			},
	...
	<div class="modal-dialog for-delete-all reminder">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<label><spring:message code="state.delete" /></label>
			</div>
			<div class="modal-footer pad_all_15 float-left width-100 border-top-width-1">
				<a id="idConfirmDelete" class="btn btn-info ph_btn_small hvr-pop hvr-rectangle-out" href="${pageContext.request.contextPath}/admin/stateDelete?id=" title=<spring:message code="tooltip.delete" />><spring:message code="application.delete" /></a>
