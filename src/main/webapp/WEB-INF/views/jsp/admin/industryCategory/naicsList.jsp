...
<spring:message var="naicsListDesk" code="application.owner.naics.code.list" />
<script>
zE(function() {
  zE.setHelpCenterSuggestions({ labels: [${naicsListDesk}] });
});
</script>
										...
										<table id="tableList" class=" display table table-bordered noarrow" cellspacing="0" width="100%">
											<thead>
												<tr class="tableHeaderWithSearch">
													...
													<th search-type="text"><spring:message code="naics.code" /></th>
													<th search-type="text"><spring:message code="naics.name" /></th>
													<th search-type="text"><spring:message code="servicecatagory.parent" /></th>
...
<%-- 										<spring:url value="/admin/naics" var="createUrl" htmlEscape="true" />
										<a href="${createUrl}" class="btn btn-info top-marginAdminList"><spring:message code="naics.create" /></a> --%>
									</div>
								</div>
							</div>
							</section>
	...
	overflow: auto;
		...
		$('document').ready(function() {
			...
			var table = $('#tableList').DataTable({
				...
				"searching" : true,
				"ajax" : {
					"url" : getContextPath() + "/admin/naicsListData",
					"data" : function(d) {
					},
				...
				"columns" : [ {
					...
					"mRender" : function(data, type, row) {
						var ret ='<a href="editIndCat?id=' + row.id + '"  data-placement="top" title="Edit"><img src="${pageContext.request.contextPath}/resources/images/edit1.png"></a>  <a href="#myModal" onClick="javascript:updateLink(\'' + row.id
						+ '\');" role="button" data-placement="top" title="Delete" data-toggle="modal">';
			...
			function doCancel() {
				var link = $("a#idConfirmDelete");
				link.data('href', link.attr("href"));
				link.attr("href", '${pageContext.request.contextPath}/admin/deleteIndCat?id=');
			}
		</script>
	</div>
		...
		<div class="modal-dialog for-delete-all reminder">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<label><spring:message code="naics.delete" /></label>
				</div>
				<div class="modal-footer pad_all_15 float-left width-100 border-top-width-1">
					<a id="idConfirmDelete" class="btn btn-info ph_btn_small hvr-pop hvr-rectangle-out" href="${pageContext.request.contextPath}/admin/deleteIndCat?id=" title="Delete"><spring:message code="application.delete" /></a>
