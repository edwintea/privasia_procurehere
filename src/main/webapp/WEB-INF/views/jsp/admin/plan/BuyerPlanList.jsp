								...
								<div class="col-xs-12">
									<div class="form-group col-md-12 bordered-row">
										<div class="ph_tabel_wrapper scrolableTable_list">
											<table id="tableList" class=" display table table-bordered noarrow" cellspacing="0" width="100%">
												<thead>
													<tr class="tableHeaderWithSearch">
														...
														<th search-type="select" search-options="planTypeList"><spring:message code="plan.type" /></th>
											...
											<spring:url value="/admin/plan/buyerPlan" var="createUrl" htmlEscape="true" />
...
<script type="text/javascript">
	$('document').ready(function() {
		...
		var table = $('#tableList').DataTable({
			...
			"searching" : true,
			"ajax" : {
				"url" : getContextPath() + "/admin/plan/buyerPlanData",
				"data" : function(d) {
					//var table = $('#tableList').DataTable()
			...
			"columns" : [ {
				...
				"render" : function(data, type, row) {
					var ret = '<a href="editBuyerPlan/' + row.id + '" data-placement="top" title="Edit"><img src="${pageContext.request.contextPath}/resources/images/edit1.png"></a>';
					ret += '<a href="#myModal" onClick="javascript:deleteBuyerPlan(\'' + row.id + '\');" data-placement="top" title="Delete" role="button" data-toggle="modal">';
	...
	<div class="modal-dialog for-delete-all reminder">
		...
		<div class="modal-content">
			...
			<div class="modal-footer pad_all_15 float-left width-100 border-top-width-1">
				<a id="idConfirmBuyerPlanDelete" class="btn btn-info ph_btn_small hvr-pop hvr-rectangle-out" href="${pageContext.request.contextPath}/admin/plan/deleteBuyerPlan/" title="Delete">
					<spring:message code="application.delete" />
				</a>
				<button type="button" onclick="javascript:doBuyerPlanCancel();" class="btn btn-black btn-default ph_btn_small hvr-pop hvr-rectangle-out1" data-dismiss="modal">
