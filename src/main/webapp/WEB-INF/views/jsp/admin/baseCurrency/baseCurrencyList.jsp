...
<spring:message var="currencyListDesk" code="application.owner.currency.list" />
<script>
zE(function() {
  zE.setHelpCenterSuggestions({ labels: [${currencyListDesk}] });
});
</script>
							...
							<div class="row">
								<div class="col-xs-12">
									<div class="ph_tabel_wrapper scrolableTable_UserList">
										<table id="tableList" class=" display table table-bordered noarrow" cellspacing="0" width="100%">
											<thead>
												<tr class="tableHeaderWithSearch">
													...
													<th search-type="text"><spring:message code="currency.code" /></th>
													<th search-type="text"><spring:message code="currency.name" /></th>
										...
										<form method="get" action="baseCurrency">
...
.scrolableTable_UserList>div.dataTables_wrapper {
	...
	<script type="text/javascript">
		...
		function doCancel() {
			var link = $("a#idConfirmDelete");
			link.data('href', link.attr("href"));
			link.attr("href", '${pageContext.request.contextPath}/admin/deleteCurrency?id=');
		}
...
// 				$('div[id=idGlobalError]').hide();
			...
			"searching" : true,
			"ajax" : {
				"url" : getContextPath() + "/admin/baseCurrencyData",
				"data" : function(d) {
				},
			...
			"columns" : [ {
				...
				"mRender" : function(data, type, row) {
					return '<a href="editCurrency?id=' + row.id + '" data-placement="top" title=<spring:message code="tooltip.edit1" />><img src="${pageContext.request.contextPath}/resources/images/edit1.png"></a>  <a href="#myModal" onClick="javascript:updateLink(\'' + row.id
							+ '\');"  data-placement="top" title=<spring:message code="tooltip.delete" /> role="button" data-toggle="modal"><img src="${pageContext.request.contextPath}/resources/images/delete1.png"></a>';
				}						
			}, {
				"mData" : "currencyCode"
			}, {
		...
		<div class="modal-dialog for-delete-all reminder">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<label><spring:message code="basecurrency.delete" /></label>
				</div>
				<div class="modal-footer pad_all_15 float-left width-100 border-top-width-1">
					<a id="idConfirmDelete" class="btn btn-info ph_btn_small hvr-pop hvr-rectangle-out" href="${pageContext.request.contextPath}/admin/deleteCurrency?id=" title="Delete"><spring:message code="application.delete" /></a>
