...
<sec:authorize access="(hasRole('ROLE_SUPPLIER_FORMS') or hasRole('ADMIN')) and hasRole('BUYER')" var="canEdit" />
...
<div id="page-content" view-name="supplierFormList">
	<div class="container col-md-12">
		...
		<ol class="breadcrumb">
			...
			<li class="active">
				<spring:message code="supplierForm.list" />
			</li>
		</ol>
									...
									<table id="tableList" class=" display table table-bordered noarrow" cellspacing="0" width="100%">
										<thead>
											<tr class="tableHeaderWithSearch">
												...
												<th search-type="text"><spring:message code="supplierForm.name" /></th>
												<th search-type="text"><spring:message code="supplierForm.description" /></th>
												...
												<th search-type=""><spring:message code="supplier.form.pending" /></th>
												<th search-type=""><spring:message code="supplier.form.submitted" /></th>
												<th search-type=""><spring:message code="supplier.form.accepted" /></th>
												<th search-type="select" search-options="statusList"><spring:message code="application.status" /></th>
											</tr>
										</thead>
									</table>
									<spring:url value="/buyer/supplierForm" var="createUrl" htmlEscape="true" />
									<c:if test="${canEdit}">
										<a href="${createUrl}" class="btn btn-info top-marginAdminList"> <spring:message code="supplierForm.create" />
										</a>
									</c:if>
								</div>
	...
	<div class="modal-dialog for-delete-all reminder">
		...
		<div class="modal-content">
			...
			<div class="modal-footer pad_all_15 float-left width-100 border-top-width-1">
				<a id="idConfirmDelete" class="btn btn-info ph_btn_small pull-left hvr-pop hvr-rectangle-out" href="${pageContext.request.contextPath}/buyer/deleteSupplierForm?id=" title="Delete"> <spring:message code="application.delete" />
				</a>
...
$('document').ready(function(){
	var table=$('#tableList').DataTable({
		...
		"searching" : true,
		"ajax":{
			"url":getContextPath()+"/buyer/supplierFormsListData",
			"data":function(d){
			},
		...
		"columns":[{
				...
				"mRender":function(data,type,row){
					...
					ret += '<a href="editSupplierForm?id=' + row.id +'" title="Edit"><img src="${pageContext.request.contextPath}/resources/images/edit1.png"></a>'; 
...
function doCancel() {
	var link = $("a#idConfirmDelete");
	link.data('href', link.attr("href"));
	link.attr("href", '${pageContext.request.contextPath}/buyer/deleteSupplierForm?id=');
}
</script>