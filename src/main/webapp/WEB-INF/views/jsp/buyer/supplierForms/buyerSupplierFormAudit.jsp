...
<div class="panel sum-accord marg-top-5">
	<div class="panel-heading">
		<h4 class="panel-title">
			<a data-toggle="collapse" class="accordion collAudit" href="#collapseAudit"> <spring:message code="poSummary.audit.label" /> </a>
		</h4>
	</div>
		...
		<div class="panel-body">
			<div class="table-responsive width100 borderAllData">
				<table class="tabaccor padding-none-td table" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:0px;">
					...
					<tbody>
						<c:forEach items="${supplierFormAuditList}" var="audit">
							<tr>
