...
<div class="row marg-bottom-10">
	...
	<div class="col-md-5">
	<spring:message code="rfaevent.questionnaire.name.placeholder" var="cqname" />
		<form:input type="text" path="name" id="name" placeholder="${cqname}" data-validation="required length" class="form-control" data-validation-length="4-124" />
	</div>
</div>
<div class="row marg-bottom-10">
	<div class="col-md-3">
