...
<div id="page-content-wrapper">
	<div id="page-content">
		<div class="container">
			...
			<ol class="breadcrumb">
				<c:url var="grnList" value="/buyer/grnList" />
				...
				<li ><a  id="listLink" href="${grnList}"><spring:message code="grn.grnList.label" /></a> </li>
			...
			<div class="clear"></div>
			<jsp:include page="grnBuyerSummary.jsp"></jsp:include>
		</div>
	</div>
</div>