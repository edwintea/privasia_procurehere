				...
				<div class="col_12">
					<div class="white_box_brd pad_all_15">
						<section class="index_table_block">
							<c:url value="/buyer/exportGrnCsv" var="downloadGrnReport" />
							<form:form action="${downloadGrnReport}" method="get" id="exportGrnReportForm" ModelAttribute="searchFilterGrnPojo">
												...
												<table id="grnList" class=" display table table-bordered noarrow" cellspacing="0" width="100%">
													<thead>
														<tr class="tableHeaderWithSearch">
															...
															<th class="width_200 width_200_fix align-left"><spring:message code="grn.list.grn.number"/></th>
															<th class="width_200 width_200_fix align-left"><spring:message code="grn.list.grn.name"/></th>
															<th class="width_200 width_200_fix align-left"><spring:message code="grn.list.grn.referenceNumber"/></th>
															<th class="width_200 width_200_fix align-left"><spring:message code="grn.poNumber.label"/></th>
															<th class="width_200 width_200_fix align-left"><spring:message code="application.supplier"/></th>
															<th class="align-left width_200 width_200_fix"><spring:message code="label.businessUnit"/></th>
															<th class="width_200 width_200_fix align-left"><spring:message code="grn.list.grn.createdby"/></th>
															<th search-type="" class="width_200 width_200_fix align-left"><spring:message code="grn.list.grn.createddate"/></th>
															<th search-type="" class="align-left width_200 width_200_fix"><spring:message code="grn.list.grn.receiptdate"/></th>
															<th search-type="" class="align-left width_200 width_200_fix"><spring:message code="grn.list.grn.grndate"/></th>
															<th search-type="" class="align-right width_200 width_200_fix"><spring:message code="grn.list.grn.currency" /></th>
...
<script type="text/javascript">
	$('document').ready(function() {
		...
		var table = $('#grnList').DataTable({
			...
			"searching" : true,
			"ajax" : {
				"url" : getContextPath() + "/buyer/grnListData",
				"data" : function(d) {
			...
			"columns" : [{
				...
				"mRender" : function(data, type, row) {
					var action='';
					action += '<div style="display: flex;"><a href="grnView/' + row.id + '"  title=<spring:message code="tooltip.edit" />><img src="${pageContext.request.contextPath}/resources/images/edit1.png"></a>&nbsp;&nbsp;';
					if(row.status!='DRAFT'){
						action += '<a href="downloadGrn/' + row.id + '"  title=<spring:message code="tooltip.download" />><img src="${pageContext.request.contextPath}/resources/images/download.png" alt="download" /></a></div>';
					}
					return action;
				}
			}, {
				...
				"data" : "goodsReceiptDate",
				"className" : "align-left",
				"searchable" : false,
				"type": 'custom-date',
				"defaultContent" : ""
			},  {
				"data" : "grnReceivedDate",
				"className" : "align-left",
				"searchable" : false,
				"type": 'custom-date',
				"defaultContent" : ""
