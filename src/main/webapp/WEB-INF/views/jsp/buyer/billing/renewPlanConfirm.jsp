		...
		<div class="registraion_wrap">
			<div class="reg_inner">
				<div class="reg_heading">
					<spring:message code="renew.plan.confirm.renewal"/> <br />[${subscription.plan.planName.concat(' - ').concat(subscription.plan.shortDescription)}]
				</div>
				<div class="reg_form_box">
					<div class="rf_inner">
						<form class="form-horizontal" id="idSubscribeForm" action='${pageContext.request.contextPath}/buyer/billing/confirmRenew' method="post">
							...
							<div class="rf_row">
								...
								<div class="rfr_field col-md-12"">
									...
									<input type="text" id="idCompanyName" cssClass="form-control" readonly="true" placeholder="${companyname}" data-validation="required length alphanumeric " data-validation-allowing="-_ &." data-validation-length="4-124"
							...
							<div class="rf_row">
								...
								<div class="rfr_field col-md-12">
									<input type="text" class="form-control" value="${subscription.plan.currency.currencyCode} ${subscription.plan.price}" readonly="true" /> <input type="hidden" id="idPlanPrice" value="${buyer.buyerPackage.plan.price}" />
								</div>
							</div>
							<div class="rf_row">
								...
								<div class="rfr_field col-md-12">
									...
									<input type="text" cssClass="form-control" placeholder="${periodunit}" data-validation="required number" data-validation-error-msg-number="Range allowed 1 to 9999" readonly="true" data-validation-allowing="range[1;9999]"
										value="${subscription.planQuantity}" />
								</div>
							</div>
							<c:if test="${subscription.plan.chargeModel == 'PER_UNIT'}">
								<div class="rf_row">
									...
									<div class="rfr_field col-md-12">
										...
										<input type="text" id="idCreditQuantity" cssClass="form-control" placeholder="${eventlimit}" data-validation="required number" readonly="true"
											data-validation-error-msg-number="Range allowed 1 to ${subscription.plan.eventLimit} for the chosen plan" data-validation-allowing="range[1;${subscription.plan.eventLimit}]" value="${subscription.eventLimit}" />
									</div>
								</div>
							</c:if>
							<div class="rf_row">
