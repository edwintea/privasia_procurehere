...
<div id="page-content" view-name="approvalRoute">
	<div class="container col-md-12">
		<!-- pageging  block -->
		<ol class="breadcrumb">
			<li><a href="#"><spring:message code="application.dashboard" /></a></li>
			<li class="active"><spring:message code="prdraft.approval.route.title" /></li>
		</ol>
		<div class="Section-title title_border gray-bg">
			<h2 class="trans-cap manage_icon">
				<spring:message code="prdraft.approval.route.label" />
			</h2>
		</div>
								...
								<div class="col-xs-12">
									<div class="form-group col-md-12 bordered-row">
										<div class="ph_tabel_wrapper scrolableTable_UserList">
											<table id="tableList" class="ph_table display table table-bordered noarrow" cellspacing="0" width="100%">
												<thead>
													<tr class="tableHeaderWithSearch">
														...
														<th search-type="text"><spring:message code="admin.approvallist.value" /></th>
											...
											<spring:url value="/buyer/approval/approvalRoute" var="createUrl" htmlEscape="true" />
 											<a href="${createUrl}" class="btn btn-info top-marginAdminList"><spring:message code="prdraft.create.approval.route" /></a>
										</div>
...
// 			$('div[id=idGlobalError]').hide();
		...
		"searching" : true,
		"ajax" : {
			"url" : getContextPath() + "/buyer/approval/approvalRouteData",
			"data" : function(d) {
			},
		...
		"columns" : [ {
			...
			"mRender" : function(data, type, row) {
				return '<a href="editApprovalRoute/' + row.id + '"  data-placement="top" title=<spring:message code="tooltip.edit" />><img src="${pageContext.request.contextPath}/resources/images/edit1.png"></a>  <a href="#myModal" onClick="javascript:updateLink(\'' + row.id
						+ '\');" role="button"  data-placement="top" title=<spring:message code="tooltip.delete" /> data-toggle="modal" ><img src="${pageContext.request.contextPath}/resources/images/delete1.png"></a>';
			}						
		}, {
			"mData" : "routeTitle"
		}, {
