    ...
    <div class="center-content row">
        ...
        <div class="col-md-6 center-margin">
            <div class="server-message wow bounceInDown inverse">
                ...
                <h2><spring:message code="error.page"/></h2>
                <p><spring:message code="error.exist"/></p>

                <form>
                    <button type="submit" class="btn btn-lg btn-success" formaction="${pageContext.request.contextPath}/" formtarget="_self" formmethod="get" ><spring:message code="error.return.previous"/></button>
                </form>
            </div>
        </div>
