		...
		<div class="panel-body">
			<div class="table-responsive width100 borderAllData">
				<table class="tabaccor padding-none-td table" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:0px;">
					...
					<tbody>
						<c:forEach items="${prAuditList}" var="audit">
							<tr>
								...
								<td class="align-left width_200 white-space-pre" style="color: ${audit.action == 'CANCELLED' or audit.action == 'ERROR' ? '#e74c3c' : (audit.action == 'TRANSFERRED' ? '#29b765' :  (audit.action == 'DELIVERED' ? '#0095d5' : ''))}; white-space: normal;">${audit.description}</td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
