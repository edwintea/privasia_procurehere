...
<div id="page-content" view-name="prTemplate">
	<div class="container col-md-12">
		<!-- pageging  block -->
		<ol class="breadcrumb">
			<li>
				<a href='<c:url value="buyerDashboard"/>'>
									...
									<div class="form-group col-md-12 bordered-row">
										<div class="ph_tabel_wrapper scrolableTable_list">
											<table id="tableList" class=" display table table-bordered noarrow" cellspacing="0" width="100%">
												<thead>
													<tr class="tableHeaderWithSearch">
														<th search-type="text" class="width_100_fix"><spring:message code="application.action" /></th>
											...
											<a href="${canEdit ? createUrl : '#'}" class="btn btn-info top-marginAdminList ${canEdit ? '' : 'disableEve'} ${!buyerReadOnlyAdmin ? '':'disabled'}">
												<spring:message code="rfxTemplate.create" />
											</a>
										</div>
		...
		var table = $('#tableList').DataTable({
			...
			"columns" : [ {
				...
				"render" : function(data, type, row) {
					var ret = '<a href="editPrTemplate?id=' + row.id + '"  title=<spring:message code="tooltip.edit" />><img src="${pageContext.request.contextPath}/resources/images/edit1.png"></a>';
	...
	<div class="modal-dialog for-delete-all reminder">
		...
		<div class="modal-content">
			...
			<div class="modal-footer pad_all_15 float-left width-100 border-top-width-1">
				<a id="idConfirmDelete" class="btn btn-info ph_btn_small hvr-pop hvr-rectangle-out" href="${pageContext.request.contextPath}/buyer/deletePrTemplate?id=" title=<spring:message code="tooltip.delete"/>>
