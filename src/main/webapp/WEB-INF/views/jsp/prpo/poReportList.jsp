				...
				<div class="col_12">
					<div class="white_box_brd pad_all_15">
						<section class="index_table_block">
							<c:url value="/buyer/poReports" var="downloadPoReport" />
							<form:form action="${downloadPoReport}" method="post" id="exportPoReportForm" ModelAttribute="searchFilterPrPojo">
								...
								<div class="col-md-12 marg-top-10 mb-10">
									...
									<div class="row">
										...
										<div class="col-md-5">																			
											<button id="exportPoReport" class="btn btn-sm btn-success hvr-pop marg-left-10 f-r h-37" data-toggle="tooltip" data-placement="top" data-original-title='<spring:message code="po.export.report" />'>
												...
												<table id="tableList" class=" display table table-bordered noarrow" cellspacing="0" width="100%">
													<thead>
														<tr class="tableHeaderWithSearch">
															...
															<th search-type="" class="width_100 width_100_fix align-left"><spring:message code="buyer.setting.export" /></th>
															<th class="width_200 width_200_fix align-left"><spring:message code="eventdetails.event.referencenumber" /></th>
															<th class="width_200 width_200_fix align-left"><spring:message code="buyer.dashboard.po.name"/></th>
															...
															<th class="width_200 width_200_fix align-left"><spring:message code="buyer.dashboard.po.createdby"/></th>
															<th search-type="" class="width_200 width_200_fix align-left"><spring:message code="buyer.dashboard.po.createddate"/></th>
															<th search-type="" class="width_200 width_200_fix align-right"><spring:message code="buyer.dashboard.po.grandtotal"/></th>
...
<script type="text/javascript">
	$('document').ready(function() {
		...
		var table = $('#tableList').DataTable({
			...
			"searching" : true,
			"ajax" : {
				"url" : getContextPath() + "/buyer/poReportListData",
				"data" : function(d) {
...

			{
				...
				'orderable' : false,
				"render" : function(data, type, row) {
					var action = '<i class="fa fa-check" aria-hidden="true" data-toggle="tooltip" data-placement="center" data-original-title="PO Report Sent"></i>';
					return action;
				}
		...
		$("#exportPoReport").click(function(e) {
			...
			if (typeof val === 'undefined' || val == '') {
				...
				$('#exportPoReport').before('<p style="margin-top:10px;" class="error-range text-danger">Please Select atleast one PR</p>');
				return false;
			} else {
