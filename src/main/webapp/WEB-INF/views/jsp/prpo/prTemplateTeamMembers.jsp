...
<script type="text/javascript">
    ...
    $('.addTemplateTeamMembers').click(function(e) {
        ...
        if (teamMemberType == undefined || teamMemberType == "") {
            teamMemberType = "Associate_Owner";
        }
    ...
    function userListForEvent(data) {
        ...
        $.each(data, function(i, user) {
            ...
            // Remove the icon display, but keep the hidden input and dropdown functionality
            ...
            userList += '<a class="adm_menu_link dropdown-toggle" data-toggle="dropdown"></a>';

            // Keep the dropdown menu
            userList += '<ul class="dropdown-menu dropup">';
            userList += '<li><a href="javascript:void(0);" class="small"><input ';
            ...
            userList += '</ul></div></div></td>';

            userList += '<td><div class="cqa_del" data-toggle="dropdown" title="Delete"><a href="#" list-type="Team Member" class="removeApproversList"></a></div></td></tr>';
