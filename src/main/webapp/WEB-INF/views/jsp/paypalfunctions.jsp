...
<%
	...
	'------------------------------------
	*/
	gv_APIUserName	= "jb-us-seller_api1.paypal.com";
	gv_APIPassword	= "WX4WTU3S8MY44S7F";
	gv_APISignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31A7yDhhsPUU2XhtMoZXsWHFxu-RWy";
...
<%!
	...
	*********************************************************************************/
												...
												HttpSession session)
	{
		...
		System.out.println("Sending to payment gateway...");
		...
		*/
		...
		resulting errors
		*/
		System.out.println("Sending to payment gateway with data : " + nvpstr);
		
	    HashMap nvp = httpcall("SetExpressCheckout", nvpstr);
		System.out.println("Payment gateway response : " + nvp.get("ACK"));
	...
	*********************************************************************************/
								...
								HttpSession session)
	{
		  ...
		  System.out.println("Calling express payment process....");
		session.setAttribute("paymentType", paymentType);
		session.setAttribute("currencyCodeType", currencyCodeType);
	...
	*********************************************************************************/
	public void RedirectURL( String token, HttpServletResponse response )
	{
		...
		{
			System.out.println("Error redirecting to PayPal... : " + e.getMessage());
		}
