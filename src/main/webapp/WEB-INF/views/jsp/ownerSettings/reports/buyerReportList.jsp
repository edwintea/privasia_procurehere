...
<div id="page-content" view-name="paymentTransaction">
	<div class="container col-md-12">
		...
		<ol class="breadcrumb">
			...
			<li class="active"><spring:message code="owner.reports.buyer.list" /></li>
		</ol>
		<div class="Section-title title_border gray-bg">
			<h2 class="trans-cap manage_icon"><spring:message code="owner.reports.buyer.list" /></h2>
		</div>
				...
				<div class="col_12">
					<div class="white_box_brd pad_all_15">
						<section class="index_table_block">
							<c:url value="/owner/exportBuyerReport" var="downloadBuyerReport" />
							<form:form action="${downloadBuyerReport}" method="get" id="exportBuyerReportForm" ModelAttribute="searchFilterPoPojo">
								...
								<div class="col-md-12 marg-top-10 mb-10">
									...
									<div class="row">
										...
										<div class="col-md-5">																			
											<button id="exportBuyerReport" class="btn btn-sm btn-success hvr-pop marg-left-10 f-r h-37" data-toggle="tooltip" data-placement="top" data-original-title='<spring:message code="owner.export.buyer.report" />'>
												<input type="hidden" id="buyerReportId" value="false"> <span class="glyph-icon icon-separator"> <i class="glyph-icon icon-download"></i>
												</span> <span class="button-content"><spring:message code="owner.export.buyer.report" /></span>
											</button>
													...
													<div class="col-xs-12">
														<div class="form-group col-md-12 bordered-row">
															<div class="ph_tabel_wrapper scrolableTable_list">
																<table id="buyerList" class=" display table table-bordered noarrow" cellspacing="0" width="100%">
																	<thead>
																		<tr class="tableHeaderWithSearch">
																				...
																				<th style="text-align: left;" search-type="text" class="width_200 width_200_fix align-left"><spring:message code="owner.reports.buyer.companyname"/></th>
																				<th style="text-align: left;" search-type="text" class="width_200 width_200_fix align-left"><spring:message code="owner.reports.buyer.regNumber"/></th>
																				<th style="text-align: left;" search-type="select" search-options="companyStatusList"  class="width_200 width_200_fix align-left"><spring:message code="owner.reports.buyer.companyType" /></th>
																				<th style="text-align: left;" search-type="text" class="width_200 width_200_fix align-left"><spring:message code="owner.reports.buyer.country"/></th>
																				<th style="text-align: left;" search-type="select" search-options="planTypeList"  search-type="text" class="align-left width_200 width_200_fix"><spring:message code="owner.reports.buyer.planType" /></th>
																				<th search-type="" class="align-left"><spring:message code="import.reg.date" /></th>
																				<th search-type="select" search-options="statusList"  class="align-center width_150_fix" class="width_200 width_200_fix align-left"><spring:message code="owner.reports.buyer.accountStatus"/></th>
																		</tr>
																	</thead>
																</table>
															</div>
...
// 				$('div[id=idGlobalError]').hide();
			...
			"searching" : true,
			"ajax" : {
				"url" : getContextPath() + "/owner/buyerReportListData",
				"data" : function(d) {
			...
			"columns" : [{
				...
				'render' : function(data, type, row) {
					return '<input type="checkbox" class="custom-checkbox1" value="'+row.id+'" id="buyerIds" name="buyerIds">';
				}
			}, {
				"data" : "companyName",
		...
		$('#buyerList thead tr:nth-child(1) th').each(function(i) {
			var title = $(this).text();
		...
		htmlSearch += '</tr>';
		$('#buyerList thead').append(htmlSearch);
		...
		$("#exportBuyerReport").click(function(e) {
			...
			if (typeof val === 'undefined' || val == '') {
				...
				$('#buyerList').before('<p style="margin-top:10px;" class="error-range text-danger">Please Select atleast one Buyer</p>');
				return false;
			} else {
				$('#exportBuyerReportForm').submit();
			}
