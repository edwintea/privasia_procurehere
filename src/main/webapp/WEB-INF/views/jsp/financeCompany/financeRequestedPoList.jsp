...
<div id="page-content">
	<div class="container col-md-12">
		...
		<ol class="breadcrumb">
			...
			<li class="active">Requested PO List</li>

		</ol>
		<div class="Section-title title_border gray-bg">
			<h2 class="trans-cap manage_icon">Requested PO List</h2>
		</div>
		<div class="container-fluid col-md-12">
			...
			<div class="row">
				...
				<div class="col-md-6 marg-top-10">
					...
					<div class="row">
						<div class="col-md-8 col-sm-8">
							<select name="supplierCompanyList" class="chosen-select rec_inp_style2 supplierCompanyList" id="supplierCompanyList">
								<option value=""></option>
				...
				<c:url value="/finance/getFinancePoReports" var="downloadPoReport" />
				<form action="${downloadPoReport}" method="post" id="exportPoReportForm">
											...
											<table id="tableList" class="data  display table table-bordered noarrow" cellspacing="0" width="100%">
												<thead>
													<tr class="tableHeaderWithSearch">
														...
														<th search-type="select" search-options="financePoStatus">Finance Status</th>
												...
												<tbody class="requestedTableBody">
												</tbody>
											</table>
										</div>
					...
					<button id="exportPoReport" class="btn btn-sm btn-success hvr-pop marg-left-10 marg-top-10" data-toggle="tooltip" data-placement="top" data-original-title="Export PO Report">
						<input type="hidden" id="poReportId" value="false">
...
<script type="text/javascript">
	...
	$('document').ready(function() {
		...
		table = $('#tableList').DataTable({
			...
			"searching" : true,
			"ajax" : {
				"url" : getContextPath() + "/finance/requestedPoListData",

				"data" : function(d) {
					d.dateTimeRange = $("input[name='dateTimeRange']").val(), d.selectedSupplier = $("#supplierCompanyList").val();
					console.log(d);
				},
			...
			"columns" : [ {
				...
				"mRender" : function(data, type, row) {
					var action = '<input type="hidden" value = "'+row.po.id+'" id="poIds" name="poIds" >';
					action += '<a href="financePOView/' + row.po.id + '"   data-placement="top" title="Edit"><img src="${pageContext.request.contextPath}/resources/images/edit1.png"></a>&nbsp;&nbsp;';
		...
		$('#exportPoReport').click(function(e) {
			e.preventDefault();
			if ($('.requestedTableBody > tr > td ').hasClass('dataTables_empty') == true) {
				var error = "No records found";
				$.jGrowl(error, {
					sticky : false,
					position : 'top-right',
					theme : 'bg-red'
