		...
		<div class="tab-content current tc_box" id="tab-1" style="display: none;margin-top: 4%;padding: 3% 0 3% 0;">
			...
			<div class="tom_dis_content">
				<div>
					...
					<div class="tc-style06">
						...
						<span>
							<input type="checkbox" ${not empty errors ? 'disabled="disabled"' : ''} name="agree" id="agree" value="agree">
			...
			<div class="tom_bot row">
				...
				<div class="col-md-6 tc-style06" style="padding-left: 0px">
					<c:url var="financeCompanyTermsOfUse" value="financeCompanyTermsOfUse" />
					<form:form action="${financeCompanyTermsOfUse}" id="demo-form" method="post" modelAttribute="financeCompany" autocomplete="off">
						<form:hidden path="id" />
						...
						<div class="tob_btn">
							<c:if test="${empty errors}">
								<button type="submit" disabled="disabled" id="agreeSubmit" class="tbb_blue  hvr-pop hvr-rectangle-out">Accept</button>
							</c:if>
						</div>
						<div class="tob_btn">
