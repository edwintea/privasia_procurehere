...
.tourButton .button:hover, button:hover, input[type="submit"]:hover, input[type="reset"]:hover,
...
<ol class='tourbus-legs' id='industryCategoryTour'>
	<li data-orientation='centered' data-highlight="true">
		...
		<div>
			<a href='javascript:void(0);' class='tourButton remove-bottom tourbus-next' style="float: right">
	...
	<li data-el='#idIndustryCategoryDiv' data-orientation='left' data-align="center" data-width='400' data-highlight="true">
		...
		<div>
			<a href='javascript:void(0);' class='tourButton remove-bottom tourbus-stop'>
				<span>x</span>
				<spring:message code="eventReport.cls" />
			</a>
			<a href='javascript:void(0);' class='tourButton remove-bottom tourbus-next' style="float: right">
				<spring:message code="rfaevent.show.me" />
				<span>»</span>
			</a>
		</div>
	</li>
	<li data-el='#idIndustryCategoryMenu' data-orientation='bottom' data-width='300' data-highlight="true">
		...
		<div>
			<a href='javascript:void(0);' class='tourButton remove-bottom tourbus-stop' style="float: right">
				<span>x</span>
				<spring:message code="rfaevent.done" />!
			</a>
		</div>
	</li>
</ol>
...
$(document).ready(function() {
	...
	${empty addressList ? 'addressTour.depart();' : (empty industryCategoryList ? 'industryCategoryTour.depart()' : '')}
	</c:if>
	
	<c:if test="${eventType == 'RFA' }">  
	  ${empty industryCategoryList ? 'industryCategoryTour.depart()' : ''}
	</c:if>
});
</script>