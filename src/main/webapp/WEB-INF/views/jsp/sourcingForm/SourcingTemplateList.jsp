...
<div id="page-content" view-name="rfxTemplate">
	<div class="container col-md-12">
		...
		<ol class="breadcrumb">
			...
			<li class="active"><spring:message code="prtemplate.template.list" /></li>
		</ol>
		<div class="Section-title title_border gray-bg">
			<h2 class="trans-cap manage_icon"><spring:message code="prtemplate.template.list" /></h2>
		</div>
											...
											<table id="tableList" class=" display table table-bordered noarrow" cellspacing="0" width="100%">
												<thead>
													<tr class="tableHeaderWithSearch">
														<th search-type="text" class="width_100_fix">
															<spring:message code="application.action" />
														</th>
														<th search-type="text">
															<spring:message code="rfxTemplate.templateName" />
														</th>
														<th search-type="text" class="width_300_fix">
															<spring:message code="rfxTemplate.templateDescription" />
														</th>
														<%-- <th search-type="select" search-options="rfxTypeList"><spring:message code="rfxTemplate.type" /></th> --%>
														<th search-type="text" class="">
															<spring:message code="application.createdby" />
														</th>
														<th search-type="" class="width_200 width_200_fix">
															<spring:message code="application.createddate" />
														</th>
														<th search-type="text" class="width_200 width_200_fix">
															<spring:message code="application.modifiedby" />
														</th>
														<th search-type="" class="width_200 width_200_fix">
															<spring:message code="application.modifieddate" />
														</th>
														<th search-type="select" search-options="statusList">
															<spring:message code="application.status" />
														</th>
													</tr>
												</thead>
											</table>
											<spring:url value="/buyer/prTemplate" var="createUrl" htmlEscape="true" />
											<sec:authorize access="hasRole('PR_TEMPLATE_EDIT') or hasRole('ADMIN')" var="canEdit" />
											<a href="${canEdit ? createUrl : '#'}" class="btn btn-info top-marginAdminList ${canEdit ? '' : 'disableEve'} ${!buyerReadOnlyAdmin ? '':'disabled'}"> <spring:message code="rfxTemplate.create" />
											</a>
										</div>
...
<script type="text/javascript">
	$('document').ready(function() {
		...
		var table = $('#tableList').DataTable({
			...
			"searching" : true,
			"ajax" : {
				"url" : getContextPath() + "/buyer/prTemplateData",
				"data" : function(d) {
					//var table = $('#tableList').DataTable()
			...
			"columns" : [ {
				...
				"render" : function(data, type, row) {
					var ret = '<a href="editPrTemplate?id=' + row.id + '"><img src="${pageContext.request.contextPath}/resources/images/edit1.png"></a>';
	...
	function doCancel() {
		var link = $("a#idConfirmDelete");
		link.data('href', link.attr("href"));
		link.attr("href", '${pageContext.request.contextPath}/buyer/deletePrTemplate?id=');
	}
</script>
<style>
.disableEve:hover {
	...
	<div class="modal-dialog for-delete-all reminder">
		...
		<div class="modal-content">
			...
			<div class="modal-footer pad_all_15 float-left width-100 border-top-width-1">
				<a id="idConfirmDelete" class="btn btn-info ph_btn_small hvr-pop hvr-rectangle-out" href="${pageContext.request.contextPath}/buyer/deletePrTemplate?id=" title="Delete"> <spring:message code="application.delete" />
				</a>
