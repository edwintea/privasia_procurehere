...
<div class="row marg-bottom-20">
	...
	<div class="col-md-5">
		...
		<input type="text" id="bqName" placeholder='<spring:message code="bq.placeholder"/>' data-validation="required" class="form-control" data-validation-error-msg-required="${required}" />
	</div>
</div>
<div class="row marg-bottom-20">
	<div class="col-md-3">
...
<div class="row marg-bottom-20">
	...
	<div class="col-md-5">
		<button type="button" class="btn btn-info ph_btn_midium hvr-pop hvr-rectangle-out " id="bqSave"><spring:message code="application.save" /></button>
