...
<div id="page-content" view-name="rfxTemplate">
	<div class="container col-md-12">
		...
		<ol class="breadcrumb">
			...
			<li class="active">
				<spring:message code="sourcingtemplate.list" />
			</li>
		</ol>
		<div class="Section-title title_border gray-bg">
			<h2 class="trans-cap manage_icon">
				<spring:message code="sourcingtemplate.title" />
			</h2>
		</div>
								...
								<div class="col-xs-12">
									<div class="form-group col-md-12 bordered-row">
										<div class="ph_tabel_wrapper scrolableTable_list">
											...
											<spring:url value="/buyer/sourcingTemplateDetails" var="createUrl" htmlEscape="true" />
...
<script type="text/javascript">
	...
	$('document').ready(function() {
		...
		var table = $('#tableList').DataTable({
			...
			"searching" : true,
			"ajax" : {
				"url" : getContextPath() + "/buyer/sourcingTemplateData",
				"data" : function(d) {
					//var table = $('#tableList').DataTable()
			...
			"columns" : [ {
				...
				"render" : function(data, type, row) {
					var ret = '<a href="editSourcingTemplate?id=' + row.id + '"><img src="${pageContext.request.contextPath}/resources/images/edit1.png"></a>';
					if(canEdit() === "true"){	
