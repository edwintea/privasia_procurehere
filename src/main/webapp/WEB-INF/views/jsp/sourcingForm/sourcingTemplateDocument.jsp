...
<spring:message var="rfsDocumentsDesk" code="application.pr.create.documents" />
        ...
        <div class="container">
            ...
            <section class="create_list_sectoin">
                <div class="Section-title title_border gray-bg mar-b20">
                    <h2 class="trans-cap tender-request-heading"><spring:message code="sourcing.form.template.label" /> ${eventType.value}</h2>
                            ...
                            <div class="ph_table_border">
                                <div class="mega">
                                    ...
                                    <table class="data ph_table border-none" width="100%"
                                        ...
                                        <tbody>
                                        <c:forEach var="doc"
                                                   items="${event.rfsTemplateDocuments}">
                                            <tr>
                                                <td class="width_200 width_200_fix align-center">
                                                    <form method="GET">
                                                        <input type="hidden" name="${_csrf.parameterName}"
                                                               value="${_csrf.token}" />
                                                        <c:url var="downloadRfsTemplateDocument"
                                                               value="/buyer/downloadRfsTemplateDocument/${doc.id}" />
                                                        <a id="downloadButton" href="${downloadRfsTemplateDocument}"
                                                           data-placement="top" title="Download"> <img
                                                                src="${pageContext.request.contextPath}/resources/images/download.png">
                                                        </a> &nbsp;

                                                     <c:if test="${!event.isTemplateUsed}">
                                                                ...
                                                                editDocDec="<c:out value='${doc.description}'/>"> <img
                                                ...
                                                <td class="width_100 width_100_fix align-left">${doc.fileSizeInKb}KB</td>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-xs-12 col-ms-12">
                                <%--<c:url var="createRfsDetails"
                                       value="/buyer/editSourcingTemplate?id=${sourcingFormTemplate.id}" />--%>
                                <a href="<c:url value="/buyer/editSourcingTemplate?id=${formId}" />" id="previousButton"
                                ...
                                <c:url var="rfsDocumentNext"
                                       value="/buyer/sourcingFormCqList/${event.id}" />
...
<script type="text/javascript"
        src="<c:url value="/resources/js/view/sourcingTemplateDocument.js?4"/>"></script>
<script type="text/javascript"
