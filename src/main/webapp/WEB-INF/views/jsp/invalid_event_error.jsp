    ...
    <div class="center-content row">
        ...
        <div class="col-md-6 center-margin">
            <div class="server-message wow bounceInDown inverse">
                <h1><spring:message code="application.error3"/></h1>
                <h2><spring:message code="error.access2"/></h2>
                <p>${requestedUrl}</p>
                <p><spring:message code="error.login2"/>
                	<a href="<c:url value="/supplier/supplierDashboard"/>" ><spring:message code="application.home"/></a> 
                </p>
            </div>
        </div>
