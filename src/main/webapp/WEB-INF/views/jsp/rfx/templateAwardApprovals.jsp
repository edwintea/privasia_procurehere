...
<div class="panel sum-accord Approval-tabs">
	<div class="panel-heading">
		<h4 class="panel-title">
			...
			<c:if test="${eventPermissions.owner and event.status == 'PENDING'}">
				<button class="editApprovalPopupButton sixbtn" data-toggle="dropdown"  title="Edit">
	...
	<div id="collapseeleven" class="panel-collapse collapse accortab in">
		<div class="panel-body eleven-contant pad_all_15">
			<c:forEach items="${rfxTemplate.awardApprovals}" var="approval">
	...
	<div class="remark-tab event_info pad0">
		<h4><spring:message code="summary.details.approval.comments" /></h4>
