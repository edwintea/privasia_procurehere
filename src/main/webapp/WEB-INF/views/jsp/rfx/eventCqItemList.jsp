		...
		<div class="container">
			...
			<section class="create_list_sectoin">
				<div class="Section-title title_border gray-bg">
					<h2 class="trans-cap"><spring:message code="questionnaire.create.list" /></h2>
													...
													<div class="wrapper-demo">
														<div id="dd" class="wrapper-dropdown-3" tabindex="1">
															...
															<ul class="dropdown">
																...
																<spring:message code="cq.option.documentDownloadLink.value" var="cqDocDownloadLink" />
																<li data-cqtype="${cqDocDownloadLink}"><a href="#"> <img style="width: 18px !important; padding: 0; margin-right: 22px;" src="<c:url value="/resources/assets/images/downloadAnswer.svg"/>"> <spring:message code="cq.option.documentDownloadLink" />
																</a></li>
															</ul>
														</div>
													</div>
											...
											<div class="col-md-9 col-sm-9">
												...
												<div class="input-group search_box_gray">
													<select class="chosen-select chosen" id="documentListArray" name="documentList" multiple data-placeholder="Select Document">
														<!-- <option selected disabled data-default>Select Document..</option> -->
												...
												<%-- <select id=documentListArray class="chosen-select" cssClass="form-control chosen-select" data-validation="required" name="documentList" multiple="multiple" data-placeholder="Select Document">
													<option value="" disabled="disabled">Select Document</option>
													<c:forEach items="${eventDocumentList}" var="document">
														<option value=" ${document.id}">${document.fileName}</option>
													</c:forEach>
												</select> --%>
										...
										<div class="menuDiv">
											<table class="table data ph_table diagnosis_list sorted_table">
												<tr class="sub_item" data-id="${cq.id}">
													...
													<td class="width_50 width_50_fix align-left"><span id="appLevel" class="section_name" value="${cq.level}">${cq.level}.${cq.order}</span></td>
													<td class="width_200 width_200_fix align-left">
													<span class="section_name">${cq.itemName}</span> 
														...
														<div class="menuDiv sub-color-change">
															<table class="table data ph_table diagnosis_list sorted_table">
																<tr class="sub_item" data-id="${cqchild.id}" data-parent="${cq.id}">
																	...
																	<td class="width_50 width_50_fix align-left"><span class="item_name">${cqchild.level}.${cqchild.order}</span></td>
...
<script type="text/javascript" src="<c:url value="/resources/js/view/eventCq.js?6"/>"></script>
<script type="text/javascript" src="<c:url value="/resources/assets/js-core/cq_form.js?4"/>"></script>
<style>
.answer_type {
	position: absolute;
	top: 5px;
