...
<div id="sb-site">
                        ...
                        <div class="example-box-wrapper wigad-new">
                            ...
                            <div class="tab-main-inner ">
                                ...
                                <div class="margin-bottom-10">
                                    <div class="meeting2-heading " id="addScheduleRateOfCreation1">
                                        <h3>
                                            <spring:message code="event.sor.create.title" />
                                        </h3>
                                        <button id="addScheduleRateOfCreation" class="pull-right btn ph_btn_midium btn-info toggleCreateBq hvr-pop hvr-rectangle-out ${!event.addScheduleOfRate ? 'disabled':'' }" type="button" data-original-title='<spring:message code="sor.add.placeholder" />' style="margin-right: 20px; margin-top: 7px; height: 30px; line-height: 1;">
                                            <spring:message code="event.sor.add.button" />
                                        </button>
                                                ...
                                                <div class="ph_tabel_wrapper">
                                                    <div class="main_table_wrapper ph_table_border payment marg-bottom-20 document-table">
                                                        ...
                                                        <table class="ph_table table border-none tab_trans timezone induslist documents-page" width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <c:forEach items="${sorEventList}" var="bq" varStatus="loop">
                                                                <tr>
                                                                    ...
                                                                    <td class="col-md-3 width_100_fix" data-id="${bq.id}">
                                                                        ...
                                                                        <form action="${pageContext.request.contextPath}/buyer/${eventType}/showSorItems" method="post">
                                                                    ...
                                                                    </td><td class="col-md-3 width_100_fix align-left" style="padding-left: 18px;">${loop.index + 1}</td>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="table_f_action_btn">
                                                <form class="bordered-row" id="submitPriviousForm" method="post" style="float: left;" action="${pageContext.request.contextPath}/buyer/${eventType}/sorPrevious">
                                                ...
                                                <form action="${pageContext.request.contextPath}/buyer/${eventType}/sorSaveDraft" method="post" style="float: right;">
                                                    <input type="hidden" id="eventId" value="${eventId}" name="eventId"> <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
                                                    <c:if test="${event.status eq 'DRAFT'}">
        ...
        <div class="modal-dialog for-delete-all reminder">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <label><spring:message code="sor.sure.delete.sor" /></label> <input type="hidden" name="confirmRemoveBqId" id="confirmRemoveBqId">
                </div>
        ...
        <div class="modal-dialog" style="width: 90%; max-width: 800px;">
            ...
            <div class="modal-content">
                                    ...
                                    <div class="menuDiv">
                                        <table class="table data ph_table diagnosis_list sorted_table" id="table_id" style=" background: #fff;">
                                            <tr class="sub_item item" data-id="${bq.id}">
                                                ...
                                                <c:if test="${bq.sorOrder != null}">
                                                    <td class="width_100 width_135_fix align-left orderChange"><span>${bq.sorOrder}</span></td>
                                                </c:if>
                                                <c:if test="${bq.sorOrder == null}">
                ...
                <div class="modal-footer  text-center">
                    <button type="button" class="btn btn-info ph_btn_midium" id="updateSorOrder" data-dismiss="modal">
    ...
    <script type="text/javascript">
        ...
        $(window).bind('load', function() {
            var allowedFields = '#priviousStep,#nextStep,.s1_view_desc,#idViewButton,#bubble,#addBqSupp,#cancelEve,#idBqSaveDraft,#addScheduleRateOfCreation,#addScheduleRateOfCreation1';
            //var disableAnchers = ['#reloadMsg'];
            disableFormFields(allowedFields);
        });
        </c:if>
