...
<spring:message var="approvalDocumentsDesk" code="application.pr.create.documents" />
<script type="text/javascript">
</script>
<div class="panel sum-accord apprdocu">
	<div class="panel-heading">
		<h4 class="panel-title">
			<a data-toggle="collapse" class="accordion" href="#collapseAdditionalDocum">Additional Documents </a>
		</h4>
	</div>
	<div id="collapseAdditionalDocum" class="panel-collapse collapse in">
		<div id="page-content-wrapper">
			<div id="page-content" style="margin-left: 1%;" class="white-bg">
				<c:if test="${eventType == 'RFT' }">
					<div class="container">
						<section class="create_list_sectoin white-bg">
							<div class="tab-pane white-bg" style="display: block">
								<div class="white-bg">
									...
									<form action="" id="additionalDocumentForm">
											...
											<div class="col-md-12">
												<div class="col-md-4 pad_all_15">
													<div class="fileinput fileinput-new input-group" data-provides="fileinput">
														...
														</span> <input name="additioanlUploadDocument" id=additioanlUploadDocument data-validation-allowing="${fileType}" data-validation-error-msg-container="#Load_File-error-dialog" data-validation-max-size="${ownerSettings.fileSizeLimit}M" type="file" data-validation="extension size" data-validation-error-msg-size="You can not upload file larger than ${ownerSettings.fileSizeLimit}MB" data-validation-error-msg-mime="${mimetypes}">
														</span>
													</div>
												...
												<div class="col-md-2 pad_all_15">
													<button class="upload_btn btn btn-info  ph_btn_midium hvr-pop hvr-rectangle-out" type="button" name="uploadAdditionalDoc" id="uploadAdditionalDoc">
						...
						<div class="ph_table_border">
							<div class="mega">
								...
								<table class="data ph_table border-none" width="100%" border="0" cellspacing="0" cellpadding="0" id="prDocList">
									<tbody>
										<c:forEach var="doc" items="${event.additionalDocument}">
											<tr>
												<td class="width_200 width_200_fix align-center">
													<form method="GET">
														<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
														<c:url var="downloadEventAdditionalDocument" value="/buyer/downloadEventAdditionalDocument/${doc.id}" />
														<a id="downloadButton" href="${downloadEventAdditionalDocument}" data-placement="top" title="Download"> <img src="${pageContext.request.contextPath}/resources/images/download.png">
														</a> &nbsp; <span> <a href="" data-placement="top" title="Delete" class="removeAdditionalDocFile" removeDocId=" ${doc.id}"> <img src="${pageContext.request.contextPath}/resources/images/delete.png">
														</a>
														</span> &nbsp; <a href="" data-placement="top" title="Edit"><span class="editAddiDocFile ${buyerReadOnlyAdmin ? 'disabled' : ''}" id="eventDocDesc" editDocId=" ${doc.id}" editDocDec="${doc.description}"> <img src="${pageContext.request.contextPath}/resources/images/edit1.png">
														</span> </a>
													</form>
												</td>
...
<div class="modal fade" id="confirmDeleteAddiDocument" role="dialog">
	<div class="modal-dialog for-delete-all reminder documentBlock">
		...
		<div class="modal-content">
			...
			<div class="modal-footer pad_all_15 float-left width-100 border-top-width-1">
				<button type="button" class="btn btn-info ph_btn_small hvr-pop hvr-rectangle-out" id="confDelAddiDocument">
...
<div class="flagvisibility dialogBox" id="documentDescriptionPopup" title="RFS Document Decription">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="align-center">
						<a href="javascript:void(0);" title="" class="btn btn-info ph_btn_small btn-tooltip hvr-pop hvr-rectangle-out" id="confDocDec" data-original-title="Delete">Update</a>
						<button type="button" class="closeDialog btn btn-black marg-left-10 hvr-pop ph_btn_small hvr-rectangle-out1">Cancel</button>
					</div>
				</div>
			</div>
		</div>
...
<script type="text/javascript" src="<c:url value="/resources/js/view/eventAdditionalDocument.js"/>"></script>
