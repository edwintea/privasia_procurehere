...
<div class="panel sum-accord marg-top-10" style="margin-bottom: 0px;">
		...
		<div class="panel-body pad_all_15">
			<div class="table-responsive width100 borderAllData">
				<table class="tabaccor padding-none-td table" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:0px;">
					...
					<tbody>
						<c:forEach items="${supplierPerformanceAuditList}" var="audit">
							<tr>
								...
								<td class="align-left width_200 white-space-pre">${audit.description}</td>
								<td class="align-left width_100_fix">
									<c:if test="${audit.hasSnapshot}">
										<form:form method="POST">
											<c:url var="download" value="/buyer/downloadAuditFile/${audit.id}" />
