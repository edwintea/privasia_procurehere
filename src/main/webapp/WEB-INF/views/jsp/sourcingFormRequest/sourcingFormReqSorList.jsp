			...
			<div id="page-content">
				<div class="container">
					...
					<div class="Section-title title_border gray-bg">
						<h2 class="trans-cap"><spring:message code="eventdescription.schedule.rate.label" /></h2>
							...
							<div class="tab-main-inner ">
								...
								<div class="margin-bottom-10">
									<div class="meeting2-heading">
										<h3><spring:message code="event.sor.create.title" /></h3>
										<button class="pull-right btn ph_btn_midium btn-info toggleCreateBq hvr-pop hvr-rectangle-out" type="button" data-toggle="tooltip" data-original-title='<spring:message code="event.sor.add.button"/>' style="margin-right: 20px; margin-top: 7px; height: 30px; line-height: 1;"><spring:message code="event.sor.add.button"/></button>
								...
								<div id="tab-5" class="tab-content current doc-fir pad_all_15" style="display: none;">
									<div class="doc-fir-inner1">
										<h3><spring:message code="eventdescription.schedule.rate.label" /></h3>
													...
													<div class="main_table_wrapper ph_table_border payment marg-bottom-20 document-table">
														...
														<table class="ph_table tabaccor padding-none-td table tab_trans timezone induslist documents-page" width="100%" border="0" cellspacing="0" cellpadding="0">
															<tbody class="catecontent">
																<c:forEach items="${sorSourcingList}" var="bq" varStatus="loop">
																	<tr>
																		<td class="col-md-3 width_100_fix" data-id="${bq.id}">
																			<form action="${pageContext.request.contextPath}/buyer/showSourcingSorItems" method="post">
																		...
																		<c:if test="${bq.sorOrder != null}">
																	      <td class="col-md-3 width_100_fix align-left" style="padding-left: 18px;">${bq.sorOrder}</td>
																	    </c:if>
																	    <c:if test="${bq.sorOrder == null}">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="table_f_action_btn">
												<form class="bordered-row" id="submitPriviousForm" method="post" style="float: left;" action="${pageContext.request.contextPath}/buyer/sourcingSorPrevious">
		...
		<div class="modal-dialog for-delete-all reminder">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<label><spring:message code="sor.sure.delete.sor"/></label>
