	...
	<div class="panel sum-accord "style="margin-top: -1%;">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a data-toggle="collapse" class="accordion" href="#collapseBq"> <spring:message code="bq.label" /> </a>
			</h4>
		</div>
							...
							<div class="ph_tabel_wrapper">
								<div class="main_table_wrapper ph_table_border mega" style="margin: 0;">
									<table class="tabaccor padding-none-td table" width="100%" border="0" cellspacing="0" cellpadding="0" style="top: 0px;">
										<thead>
											<tr>
												...
												<th class="align-right width_100 width_100_fix"><spring:message code="product.unit.price" /></th>
												<th class="align-right width_100 width_100_fix"><spring:message code="product.unit.budget.price" /></th>
											</tr>
										</thead>
									</table>
									...
									<table class="ph_table data border-none" width="100%" border="0" cellspacing="0" cellpadding="0">
										<tbody>
											<c:forEach items="${suppBq.bqItems}" var="item">
												<tr>
													...
													<td class="align-right width_100 width_100_fix">
															<fmt:formatNumber type="number" minFractionDigits="${sourcingFormRequest.decimal}" maxFractionDigits="${sourcingFormRequest.decimal}" value="${item.quantity}" />
													</td>
												
													<td class=" align-right width_100 width_100_fix">

														<c:if test="${item.order != '0' }">
															<fmt:formatNumber type="number" minFractionDigits="${sourcingFormRequest.decimal}" maxFractionDigits="${sourcingFormRequest.decimal}" value="${item.unitPrice}" />
													</c:if>
													</td>
													
													<td class="align-right width_100 width_100_fix">
															<fmt:formatNumber type="number" minFractionDigits="${sourcingFormRequest.decimal}" maxFractionDigits="${sourcingFormRequest.decimal}" value="${item.unitBudgetPrice}" />
													</td>
