...
<div class="row marg-bottom-20">
	...
	<div class="col-md-5">
		...
		<input type="text" id="bqName" palceholder="Bill of Quantity" data-validation="required, length" class="form-control" data-validation-length="1-128" data-validation-error-msg-required="${required}"  />
	</div>
</div>
<div class="row marg-bottom-20">
	<div class="col-md-3">
