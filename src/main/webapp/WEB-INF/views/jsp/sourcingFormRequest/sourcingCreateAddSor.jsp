...
<div class="row marg-bottom-20">
	...
	<div class="col-md-5">
		...
		<input type="text" id="bqName" palceholder="Schedule of Rate" data-validation="required, length" class="form-control" data-validation-length="1-124" data-validation-error-msg-required="${required}"  />
	</div>
</div>
<div class="row marg-bottom-20">
	<div class="col-md-3">
