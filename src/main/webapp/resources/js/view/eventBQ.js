	...
	function() {
			...
			var ns = $('ol.sortable').nestedSortable({
				...
				stop: function(item, currentItem) {
					...
					if (supplierBqCount != "true" && addBillOfQuantityControl == "true") {
						...
						$.ajax({
							url: getBuyerContextPath('eventBQOrder'),
		...
		$(document).on(
			...
			function() {
				...
				var bqId = $('#bqId').val();
				$.ajax({
					url: getBuyerContextPath('getBqForNewFields'),
					data: {
						bqId: bqId
					},
					type: "GET",
					...
					success: function(data, textStatus, request) {
						...
						$.each(data, function(i, item) {
							...
							if (i == "field1Label") {
								...
								id = "field2Label";
								fieldname = "field2";
								if (data.field2FilledBy == "SUPPLIER") {
									readonly = "readonly";
								} else {
									readonly = "";
								}
								...
								id = "field3Label";
								fieldname = "field3";
								if (data.field3FilledBy == "SUPPLIER") {
									readonly = "readonly";
								} else {
									readonly = "";
								}
								...
								id = "field4Label";
								fieldname = "field4";
								if (data.field4FilledBy == "SUPPLIER") {
									readonly = "readonly";
								} else {
									readonly = "";
								}
								...
								id = "field5Label";
								fieldname = "field5";
								if (data.field5FilledBy == "SUPPLIER") {
									readonly = "readonly";
								} else {
									readonly = "";
								}
								...
								id = "field6Label";
								fieldname = "field6";
								if (data.field6FilledBy == "SUPPLIER") {
									readonly = "readonly";
								} else {
									readonly = "";
								}
								...
								id = "field7Label";
								fieldname = "field7";
								if (data.field7FilledBy == "SUPPLIER") {
									readonly = "readonly";
								} else {
									readonly = "";
								}
								...
								id = "field8Label";
								fieldname = "field8";
								if (data.field8FilledBy == "SUPPLIER") {
									readonly = "readonly";
								} else {
									readonly = "";
								}
								...
								id = "field9Label";
								fieldname = "field9";
								if (data.field9FilledBy == "SUPPLIER") {
									readonly = "readonly";
								} else {
									readonly = "";
								}
								...
								id = "field10Label";
								fieldname = "field10";
								if (data.field10FilledBy == "SUPPLIER") {
									readonly = "readonly";
								} else {
									readonly = "";
								}
							}
							if (i == "field1Label" || i == "field2Label" || i == "field3Label" || i == "field4Label" || i == "field5Label" || i == "field6Label" || i == "field7Label" || i == "field8Label" || i == "field9Label"
								|| i == "field10Label") {
								additionalHtml += '<div class="col-md-6 col-sm-6 col-xs-12 extraEachBlock">' + '<div class="form-group">';
								additionalHtml += '<label>' + label + '</label>';
								additionalHtml += '<input type="text" data-validation="length" data-validation-length="0-100" class="form-control" ' + readonly + ' name="' + fieldname + '" id="' + id + '"  placeholder="Enter ' + label
									+ '" value="">' + '</div></div>';
							}
		...
		$(document).on("click", ".Edit_section_table", function() {
			...
			$.ajax({
				url: getBuyerContextPath('getBqForEdit'),
				data: {
					bqId: bqId,
					bqItemId: bqItemId
				},
					...
					success: function(data, textStatus, request) {
						...
						$.each(data.bq, function(i, item) {
							...
							if (i == "field1Label") {
								...
								id = "field1Label";
								fieldname = "field1";
								if (data.bq.field1FilledBy == "SUPPLIER") {
									readonly = "readonly";
								} else {
									readonly = "";
								}
								...
								id = "field2Label";
								fieldname = "field2";
								if (data.bq.field2FilledBy == "SUPPLIER") {
									readonly = "readonly";
								} else {
									readonly = "";
								}
								...
								id = "field3Label";
								fieldname = "field3";
								if (data.bq.field3FilledBy == "SUPPLIER") {
									readonly = "readonly";
								} else {
									readonly = "";
								}
								...
								id = "field4Label";
								fieldname = "field4";
								if (data.bq.field4FilledBy == "SUPPLIER") {
									readonly = "readonly";
								} else {
									readonly = "";
								}
								...
								id = "field5Label";
								fieldname = "field5";
								if (data.bq.field5FilledBy == "SUPPLIER") {
									readonly = "readonly";
								} else {
									readonly = "";
								}
								...
								id = "field6Label";
								fieldname = "field6";
								if (data.bq.field6FilledBy == "SUPPLIER") {
									readonly = "readonly";
								} else {
									readonly = "";
								}
								...
								id = "field7Label";
								fieldname = "field7";
								if (data.bq.field7FilledBy == "SUPPLIER") {
									readonly = "readonly";
								} else {
									readonly = "";
								}
								...
								id = "field8Label";
								fieldname = "field8";
								if (data.bq.field8FilledBy == "SUPPLIER") {
									readonly = "readonly";
								} else {
									readonly = "";
								}
								...
								id = "field9Label";
								fieldname = "field9";
								if (data.bq.field9FilledBy == "SUPPLIER") {
									readonly = "readonly";
								} else {
									readonly = "";
								}
								...
								id = "field10Label";
								fieldname = "field10";
								if (data.bq.field10FilledBy == "SUPPLIER") {
									readonly = "readonly";
								} else {
									readonly = "";
								}
						...
						$.each(data, function(i, item) {
							...
							// i);
							if (i == 'unitPrice') {
								$("#creat_subitem_form").find('[name="' + i + '"]').val(ReplaceNumberWithCommas(item.toFixed($('#eventDecimal').val())));
							} else {
								$("#creat_subitem_form").find('[name="' + i + '"]').val(item);
							}
							if (item == "BUYER_FIXED_PRICE") {
...
$(function() {
	...
	$('#itemSave').click(function(e) {
		...
		var ajaxUrl = getBuyerContextPath('createEventBQ');
		if (bqItemId != '') {
			ajaxUrl = getBuyerContextPath('updateBqItem');
		}
		$.ajax({
			url: ajaxUrl,
			data: JSON.stringify(data),
...
$('#idConfirmDeleteBQs').click(function() {
	...
	// // return false;
	$.ajax({
		url: getBuyerContextPath('deleteBqItems') + "/" + bqId,
		data: {
			'items': items,
			'filterVal': filterVal,
			'searchVal': searchVal,
...
$(document).delegate('#idConfirmDelete', 'click', function(e) {
	...
	$.ajax({
		url: getBuyerContextPath('deleteBqNewField'),
		data: {
			bqId: bqId,
			label: label,
...
$('table').delegate('#newFieldsSave', 'click', function(e) {
	...
	$.ajax({
		url: getBuyerContextPath('addNewColumns'),
		data: JSON.stringify(data),
		type: "POST",
		contentType: "application/json",
		dataType: 'json',
...
function renderGrid(item) {
	...
	if (item.bq.field1Label != undefined) {
		...
		countNewData++;
		$('.header_table.header').find('th:last-child').before('<th class="hed_4 width_200 width_200_fix extraFieldHeaders">' + item.bq.field1Label + '</th>');
	}
	if (item.bq.field2Label != undefined) {
		...
		countNewData++;
		$('.header_table.header').find('th:last-child').before('<th class="hed_4 width_200 width_200_fix extraFieldHeaders">' + item.bq.field2Label + '</th>');
	}
	if (item.bq.field3Label != undefined) {
		...
		countNewData++;
		$('.header_table.header').find('th:last-child').before('<th class="hed_4 width_200 width_200_fix extraFieldHeaders">' + item.bq.field3Label + '</th>');
	}

	if (item.bq.field4Label != undefined) {
		...
		countNewData++;
		$('.header_table.header > tbody > tr').find('th:last-child').before('<th class="hed_4 width_200 width_200_fix extraFieldHeaders">' + item.bq.field4Label + '</th>');
	}
	...
	if (item.children != undefined && item.children != null) {
		...
		$.each(item.children, function(i, child) {
			...
			if (child.bq.field1Label != undefined) {
			...
			if (child.bq.field2Label != undefined) {
			...
			if (child.bq.field3Label != undefined) {
			...
			if (child.bq.field4Label != undefined) {
...
$('#bqSave').click(function(e) {
	...
	var token = $("meta[name='_csrf']").attr("content");
	if ($.trim(bqId) != '') {
		urlAjax = getBuyerContextPath('updateBqList');
	} else {
		urlAjax = getBuyerContextPath('createBQList');
	}
	$.ajax({
		url: urlAjax,
		data: JSON.stringify(data),
...
$('#downloadTemplate').click(function(e) {
	...
	window.location.href = getBuyerContextPath('bqItemTemplate') + "/" + bqId;
})
...
$("#uploadBqItemFile").on("change", function() {
	...
	// console.log(myForm);
	$.ajax({
		url: getBuyerContextPath('uploadBqItems'),
		data: myForm,
		type: "POST",
...
function deleteBQ(bqId) {
	...
	data["eventId"] = eventId;
	$.ajax({
		url: getBuyerContextPath('deleteRftBq'),
		data: JSON.stringify(data),
		type: "POST",
		contentType: "application/json",
		dataType: 'json',
...
$('.editBqItem').click(function(e) {
	...
	$.ajax({
		type: "POST",
		url: getBuyerContextPath('getEventBqbyId'),
		data: {
			'eventId': eventId,
			'bqId': bqId
		},
...
function searchFilterBqItem(choosenVal, searchVal, pageNo, pageLength, isPageEnable, isChooseSection) {
	...
	if (supplierBqCount != "true" && addBillOfQuantityControl == "true") {
		$.ajax({
			type: "POST",
			url: getBuyerContextPath('getBqItemForSearchFilter'),
			data: {
				'eventId': eventId,
				'bqId': bqId,
				'filterVal': filterVal,
...
function drawSection(item, disableDragDrop, isPageEnable) {
	...
	if (item.bq.field4Label != undefined) {
		...
		countNewData++;
		$('.header_table.header').find('th:last-child').before('<th class="hed_4 width_200 width_200_fix extraFieldHeaders">' + item.bq.field4Label + '</th>');
	}
	if (item.bq.field5Label != undefined) {
		...
		countNewData++;
		$('.header_table.header').find('th:last-child').before('<th class="hed_4 width_200 width_200_fix extraFieldHeaders">' + item.bq.field5Label + '</th>');
	}
	if (item.bq.field6Label != undefined) {
		...
		countNewData++;
		$('.header_table.header').find('th:last-child').before('<th class="hed_4 width_200 width_200_fix extraFieldHeaders">' + item.bq.field6Label + '</th>');
	}
	if (item.bq.field7Label != undefined) {
		...
		countNewData++;
		$('.header_table.header').find('th:last-child').before('<th class="hed_4 width_200 width_200_fix extraFieldHeaders">' + item.bq.field7Label + '</th>');
	}
	if (item.bq.field8Label != undefined) {
		...
		countNewData++;
		$('.header_table.header').find('th:last-child').before('<th class="hed_4 width_200 width_200_fix extraFieldHeaders">' + item.bq.field8Label + '</th>');
	}
	if (item.bq.field9Label != undefined) {
		...
		countNewData++;
		$('.header_table.header').find('th:last-child').before('<th class="hed_4 width_200 width_200_fix extraFieldHeaders">' + item.bq.field9Label + '</th>');
	}
	if (item.bq.field10Label != undefined) {
		...
		countNewData++;
		$('.header_table.header > tbody > tr').find('th:last-child').before('<th class="hed_4 width_200 width_200_fix extraFieldHeaders">' + item.bq.field10Label + '</th>');
	}
...
$('#updateBqOrder').click(function(e) {
	...
	var token = $("meta[name='_csrf']").attr("content");
	$.ajax({
		url: getContextPath() + '/buyer/' + eventType + '/updateEventBqOrder/' + eventId,
