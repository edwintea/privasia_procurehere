								...
								$.each(data, function(i, item) {
									...
									if (item.editorMember == true) {
										table += '<tr>' + '<td class="width_200 width_200_fix align-center">' +
											'<form method="GET">' + '<a id="downloadButton" href="' + getContextPath() + '/buyer/downloadRfsDocument/' + item.id + '">' +
											'<img src="' + getContextPath() + '/resources/images/download.png"></a>&nbsp;' + '<span>' +
										...
										if (item.loggedInMember == false && item.approverMember == false) {
											table += '<span><a href="" class="removeDocFile" removeDocId="' + item.id + '"><img src="' + getContextPath()
													+ '/resources/images/delete.png"></a></span>&nbsp<a href=""><span class="editDocFile" editDocId="' + item.id + '" editDocDec="' + itemdescription + '" eventDocInternal="' + item.internal + '"><img src="' + getContextPath()
