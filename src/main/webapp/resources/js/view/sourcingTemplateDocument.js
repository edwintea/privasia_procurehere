    ...
    function() {
        ...
        $('#uploadRfsDoc').click(
            function() {
                ...
                var uploadUrl = getContextPath() + '/buyer/createRfsTemplateDocuments';
                $.ajax({
                    url : uploadUrl,
                    data : form_data,
                    cache : false,
                    ...
                    success : function(data, textStatus, request) {
                        ...
                        $.each(data, function(i, item) {
                            ...
                            if (item.editorMember == true) {
                                table += '<tr>' + '<td class="width_200 width_200_fix align-center"><form method="GET">' + '<a id="downloadButton" href="' + getContextPath() + '/buyer/downloadRfsTemplateDocument/' + item.id + '"><img src="'
                                    ...
                                    + '/resources/images/delete.png"></a></span>&nbsp<a href=""><span class="editDocFile" editDocId="' + item.id + '" editDocDec="' + itemdescription + '"><img src="' + getContextPath()
                                    + '/resources/images/edit1.png"></span></a></form></td>' + '<td class="width_200 width_200_fix align-left">' + item.fileName + '</td>' +
                                    ...
                                    '<td class="width_200 width_200_fix align-left">' + item.uploadByName + '</td></tr>';
                            } else {
                                table += '<tr>' + '<td class="width_200 width_200_fix align-center"><form method="GET">' + '<a id="downloadButton" href="' + getContextPath() + '/buyer/downloadRfsTemplateDocument/' + item.id + '"><img src="'
                                    + getContextPath() + '/resources/images/download.png"></a>&nbsp;'

                               /* if (item.loggedInMember == false && item.approverMember == false) {*/
                                    table += '<span><a href="" class="removeDocFile" removeDocId="' + item.id + '"><img src="' + getContextPath()
                                        + '/resources/images/delete.png"></a></span>&nbsp<a href=""><span class="editDocFile" editDocId="' + item.id + '" editDocDec="' + itemdescription + '"><img src="' + getContextPath()
                                ...
                                table += '<td class="width_200 width_200_fix align-left">' + item.fileName + '</td>' +
                                    '<td class="width_300 width_300_fix align-left">' + itemdescription + '</td>' +
                                    '<td class="width_100 width_100_fix align-left">' + item.fileSizeInKb + 'KB</td> ' +
                                    '<td class="width_200 width_200_fix align-left">' + item.uploadDate + '</td>' + '<td class="width_200 width_200_fix align-left">' + item.uploadByName + '</td></tr>';
                            }
...
$(document).delegate(
    ...
    function(e) {
        ...
        $.ajax({
            type : "POST",
            url : getBuyerContextPath('updateDocumentDesc'),
            data : {
                docId : docId,
                docDesc : docDesc,
                formId : formId
            ...
            success : function(data, textStatus, request) {
                ...
                $.each(data, function(i, item) {
                    ...
                    if (item.editorMember == true) {
                        table += '<tr>' + '<td class="width_200 width_200_fix align-center"><form method="GET">' + '<a id="downloadButton" href="' + getContextPath() + '/buyer/downloadRfsTemplateDocument/' + item.id + '"><img src="' + getContextPath()
                            + '/resources/images/download.png"></a>&nbsp;' + '<span><a href="" class="removeDocFile" removeDocId="' + item.id + '"><img src="' + getContextPath()
                            + '/resources/images/delete.png"></a></span>&nbsp<a href=""><span class="editDocFile" editDocId="' + item.id + '" editDocDec="' + itemdescription + '"><img src="' + getContextPath()
                            + '/resources/images/edit1.png"></span></a></form></td>' + '<td class="width_200 width_200_fix align-left">' + item.fileName + '</td>' +
                            '<td class="width_300 width_300_fix align-left">' + itemdescription
                            + '</td>' +
                            '<td class="width_100 width_100_fix align-left">' + item.fileSizeInKb + 'KB</td> ' +
                            '<td class="width_200 width_200_fix align-left">' + item.uploadDate + '</td>' + '<td class="width_200 width_200_fix align-left">' + item.uploadByName + '</td></tr>';
                    } else {
                       ...
                       /* if (item.loggedInMember == false) {*/
                            table += '<span><a href="" class="removeDocFile" removeDocId="' + item.id + '"><img src="' + getContextPath() + '/resources/images/delete.png"></a></span>&nbsp<a href=""><span class="editDocFile" editDocId="'
                                + item.id + '" editDocDec="' + itemdescription + '"><img src="' + getContextPath() + '/resources/images/edit1.png"></span></a></form></td>';
                      /*  }*/
                        table += '<td class="width_200 width_200_fix align-left">' + item.fileName + '</td>' +
                            '<td class="width_300 width_300_fix align-left">' + itemdescription + '</td>' +
                            '<td class="width_100 width_100_fix align-left">' + item.fileSizeInKb + 'KB</td> ' +
                            '<td class="width_200 width_200_fix align-left">'
                            + item.uploadDate + '</td>' + '<td class="width_200 width_200_fix align-left">' + item.uploadByName + '</td></tr>';
                    }
                });
                // console.log(table);
                $('#prDocList tbody').html(table);
...
$(document).delegate(
    ...
    function(e) {
        ...
        var removeUrl = getContextPath() + '/buyer/removeRfsTemplateDocument';
        $.ajax({
            url : removeUrl,
            data : ({
