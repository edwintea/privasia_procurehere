    ...
    function() {
        ...
        $('#uploadRftDoc').click(
            function() {
                ...
                $.ajax({
                    url :  getContextPath() + '/buyer/createRfxTemplateDocuments',
                    data : form_data,
                    cache : false,
                    ...
                    success : function(data, textStatus, request) {
                        ...
                        $.each(data, function(i, item) {
                            ...
                            var url =   getContextPath() + '/buyer/downloadRfxTemplateDocument' + "/" + item.id;
                            table +=
                                '<tr> <td class="width_200 width_200_fix align-center">' +
                                '<form method="GET"><a id="downloadDocument" href="' + url + '" title="Download">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="' + getContextPath() + '/resources/images/download.png"></a>' +
                                '&nbsp;' + '<span class="removeDocFile" removeDocId="' + item.id + '"><a href=""><img src="' + getContextPath() + '/resources/images/delete.png"  title="Delete"></a></span>' +
                                '&nbsp' + '<span class="editDocFile" editDocId="' + item.id + '" eventDocDesc="' + itemdescription + '" eventDocInternal="' + item.internal + '"><a href=""><img src="' + getContextPath() + '/resources/images/edit1.png" title="Edit"></a></span></td>' +
                                ...
                                '<td class="width_100 width_100_fix align-left">' + (item.internal == true ? "Internal" : "External") +
                                '</form></td></tr>';
                        });
                        // console.log(table);
...
$(document).delegate(
    ...
    function(e) {
        ...
        console.log("Checkbox is checked:", internal_1); // Debug log
        var header = $("meta[name='_csrf_header']").attr("content");
        var token = $("meta[name='_csrf']").attr("content");
        $.ajax({
            type : "POST",
            url :  getContextPath() + '/buyer/updateRfxTemplateDocumentDesc',
            data : {
                docId : docId,
                docDesc : docDesc,
                eventId : eventId,
            ...
            success : function(data, textStatus, request) {
                ...
                $.each(data, function(i, item) {
                    ...
                    var url =  getContextPath() + '/buyer/downloadRfxTemplateDocument' + "/" + item.id;
                    table += '<tr> <td class="width_200 width_200_fix align-center">' +
                        '<form method="GET"><a id="downloadDocument" href="' + url + '" title="Download">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="' + getContextPath() + '/resources/images/download.png"></a>&nbsp;' +
                        '<span class="removeDocFile" removeDocId="' + item.id + '"><a href="" title="Delete"><img src="' + getContextPath() + '/resources/images/delete.png"></a></span>&nbsp' +
                        '<span class="editDocFile" editDocId="' + item.id + '" eventDocDesc="' + itemdescription + '" eventDocInternal="' + item.internal + '"><a href="" title="Edit"><img src="' + getContextPath()
...
$(document).delegate(
    ...
    function(e) {
        ...
        $.ajax({
            url :  getContextPath() + '/buyer/removeRfxTemplateDocument',
            data : ({
            ...
            success : function(data, textStatus, request) {
                ...
                $.each(data, function(i, item) {
                    ...
                    table += '<tr> <td class="width_200 width_200_fix align-center">' +
                        ...
                        '<td class="width_200 width_200_fix align-left">' + item.uploadDate + '</td>' +
                        '<td class="width_200 width_200_fix align-left">' + item.uploadByName + '</td> ' +
                        '<td class="width_100 width_100_fix align-left">' + (item.internal == true ? "Internal" : "External") + '</form></td></tr>';
                });
                // console.log(table);
                $('#rftDocList tbody').html(table);
            },
