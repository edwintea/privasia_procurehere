...
(function($, window) {
  ...
  $.formUtils = $.extend($.formUtils || {}, {
    ...
    validateInput: function ($elem, language, conf, $form, eventContext) {
      ...
      $elem
        ...
        .one('beforeValidation', function() {
          ...
          if ($elem.attr('disabled') || (!$elem.is(':visible') && !conf.validateHiddenInputs) && !$elem.hasClass('chosen-select')) {
    ...
    LANG: {
      ...
      positiveCustomVal: 'The input value must be positive',
...
(function($) {
  ...
  $.formUtils.addValidator({
    ...
    validatorFunction: function (val, $el, conf, language) {
      ...
      if (additionalChars) {
        ...
        if(noValue == ''){
        	this.errorMessage = language.badAlphaNumeric + extra;
        }
        else{
  ...
  /*
   * for positive number without required
   */
    $.formUtils.addValidator({
  	    name: 'positive',
  	    required: false,
  	    ...
  	    errorMessage: '',
  	    errorMessageKey: 'positiveCustomVal'
  	  });
