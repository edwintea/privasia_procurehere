...
var DEFAULT_SETTINGS = {
    ...
    tokenFormatter: function(item) { return "<li><input type='hidden' name='catFav' value='"+item[this.tokenValue]+"'/><p>"+ item[this.propertyToSearchCode]+ '-' + item[this.propertyToSearch] + "</p></li>" },
