...
(function ($) {
  ...
  var dialogs = {
    ...
    setInlineMessage: function ($input, errorMsg, conf) {
      ...
      var $parentlbl = this.getParentContainer($input);
      //console.log(errorMsg);
      //console.log($parentlbl.find('label').html());
      if($parentlbl.find('label').length > 0){
    	  errorMsg = errorMsg.replace('The input value',$parentlbl.find('label').html());
      }
      //console.log(errorMsg);
